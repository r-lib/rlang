...
* Version: 0.1.12
* GitHub: NA
* Source code: https://github.com/cran/AeroSampleR
* Date/Publication: 2021-12-03 18:00:07 UTC
* Number of recursive dependencies: 40

Run `cloud_details(, "AeroSampleR")` for more info

</details>

## In both

*   checking whether package ‘AeroSampleR’ can be installed ... ERROR
    ```
    Installation failed.
    See ‘/tmp/workdir/AeroSampleR/new/AeroSampleR.Rcheck/00install.out’ for details.
    ```
...
```
* installing *source* package ‘AeroSampleR’ ...
** package ‘AeroSampleR’ successfully unpacked and MD5 sums checked
** using staged installation
** R
Error in parse(outFile) : 
  /tmp/workdir/AeroSampleR/new/AeroSampleR.Rcheck/00_pkg_src/AeroSampleR/R/set_params_2.R:42:11: unexpected '>'
41: 
42: df <- df |>
              ^
ERROR: unable to collate and parse R files for package ‘AeroSampleR’
* removing ‘/tmp/workdir/AeroSampleR/new/AeroSampleR.Rcheck/AeroSampleR’
...
** R
Error in parse(outFile) : 
  /tmp/workdir/AeroSampleR/old/AeroSampleR.Rcheck/00_pkg_src/AeroSampleR/R/set_params_2.R:42:11: unexpected '>'
41: 
42: df <- df |>
              ^
ERROR: unable to collate and parse R files for package ‘AeroSampleR’
* removing ‘/tmp/workdir/AeroSampleR/old/AeroSampleR.Rcheck/AeroSampleR’
...
* Version: 0.1.0.2
* GitHub: https://github.com/tsiamut/ch
* Source code: https://github.com/cran/ch
* Date/Publication: 2021-07-09 08:40:08 UTC
* Number of recursive dependencies: 36

Run `cloud_details(, "ch")` for more info

</details>

## In both

*   checking whether package ‘ch’ can be installed ... ERROR
    ```
    Installation failed.
    See ‘/tmp/workdir/ch/new/ch.Rcheck/00install.out’ for details.
    ```
...
```
* installing *source* package ‘ch’ ...
** package ‘ch’ successfully unpacked and MD5 sums checked
** using staged installation
** R
Error in parse(outFile) : 
  /tmp/workdir/ch/new/ch.Rcheck/00_pkg_src/ch/R/Ryacas-all.R:46:13: unexpected input
45: #' @export
46: sym2poly <- \
                ^
ERROR: unable to collate and parse R files for package ‘ch’
* removing ‘/tmp/workdir/ch/new/ch.Rcheck/ch’
...
** R
Error in parse(outFile) : 
  /tmp/workdir/ch/old/ch.Rcheck/00_pkg_src/ch/R/Ryacas-all.R:46:13: unexpected input
45: #' @export
46: sym2poly <- \
                ^
ERROR: unable to collate and parse R files for package ‘ch’
* removing ‘/tmp/workdir/ch/old/ch.Rcheck/ch’
...
* Date/Publication: 2022-01-10 23:42:42 UTC
...
* this is package ‘idiogramFISH’ version ‘2.0.8’
* package encoding: UTF-8
* checking package namespace information ... OK
* checking package dependencies ... NOTE
...
...
* Source code: https://github.com/cran/mispitools
* Date/Publication: 2022-01-03 23:50:01 UTC
* Number of recursive dependencies: 127

Run `cloud_details(, "mispitools")` for more info

</details>

## In both

*   checking whether package ‘mispitools’ can be installed ... ERROR
    ```
    Installation failed.
    See ‘/tmp/workdir/mispitools/new/mispitools.Rcheck/00install.out’ for details.
    ```
...
```
* installing *source* package ‘mispitools’ ...
** package ‘mispitools’ successfully unpacked and MD5 sums checked
** using staged installation
** R
** byte-compile and prepare package for lazy loading
Error in loadNamespace(i, c(lib.loc, .libPaths()), versionCheck = vI[[i]]) : 
  there is no package called ‘pedprobr’
Calls: <Anonymous> ... loadNamespace -> withRestarts -> withOneRestart -> doWithOneRestart
Execution halted
ERROR: lazy loading failed for package ‘mispitools’
* removing ‘/tmp/workdir/mispitools/new/mispitools.Rcheck/mispitools’
...
Execution halted
ERROR: lazy loading failed for package ‘mispitools’
* removing ‘/tmp/workdir/mispitools/old/mispitools.Rcheck/mispitools’
...
* checking package namespace information ... OK
* checking package dependencies ... ERROR
Package required but not available: ‘adiv’
