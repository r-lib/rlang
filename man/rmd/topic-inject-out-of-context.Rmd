...
The embrace operator `r link("{{")` is a feature available in [data-masked][topic-data-mask] arguments. If you use it elsewhere, it is interpreted as a double `{` wrapping.
