...
- [Argument defusing][topic-defuse] (also known as quoting or NSE) with [substitute()] (base R) or [enquo()] and [enquos()] (rlang). R code needs to be defused so it can be evaluated later on in a modified context.
