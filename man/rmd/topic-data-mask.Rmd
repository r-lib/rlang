...
See [Data mask programming patterns][topic-data-mask-programming] to learn more about creating functions around data-masking functions.
...
- [Argument defusal][topic-defuse] with [substitute()] (base R) or [enquo()], [enquos()], and [`{{`][embrace-operator] (rlang). R code is defused so it can be evaluated later on in a special environment enriched with data.
...
* [Defusing R expressions][topic-defuse]
