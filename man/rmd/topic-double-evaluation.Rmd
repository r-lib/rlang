...
One inherent risk to metaprogramming is to evaluate multiple times a piece of code that only appears to be evaluated once. Take this data-masking function which takes a single input and produces two summaries:
...
`{{` [embracing in glue strings][glue-operator] doesn't suffer from the double evaluation problem:
