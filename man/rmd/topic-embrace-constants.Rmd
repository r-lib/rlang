...
Function arguments are [defused][topic-defusal] into [quosures][topic-quosure] that keep track of the environment of the defused expression.
...
- Data-masking APIs should be able to interpret constants. These can arise from normal argument passing as we have seen, or by [injection][topic-injection] with `!!`. There should be no difference between `dplyr::mutate(mtcars, var = cyl)` and `dplyr::mutate(mtcars, var = !!mtcars$cyl)`.
