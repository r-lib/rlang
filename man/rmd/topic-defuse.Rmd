...
One purpose for defusing evaluation of an expression is to interface with [data-masking functions][topic-data-mask] by injecting the expression back into another function with `!!`. This is the [defuse-and-inject pattern][topic-metaprogramming].
...
Defuse-and-inject is usually performed in a single step with the embrace operator [`{{`][embrace-operator].
