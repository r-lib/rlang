...
The [`.data`] pronoun is a tidy eval feature that is enabled in all data-masked arguments, just like [`{{`][embrace-operator]. The pronoun represents the data mask and can be subsetted with `[[` and `$`. These three statements are equivalent:
