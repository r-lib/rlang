...
- [`is_syntactic_literal()`](https://rlang.r-lib.org/dev/reference/is_expression.md)
...
- [`env_browse()`](https://rlang.r-lib.org/dev/reference/env_browse.md)
  and
  [`env_is_browsed()`](https://rlang.r-lib.org/dev/reference/env_browse.md)
...
- [`env_unlock()`](https://rlang.r-lib.org/dev/reference/env_unlock.md)
  is now defunct because recent versions of R no long make it possible
...
- [`is_dictionaryish()`](https://rlang.r-lib.org/dev/reference/is_dictionaryish.md)
...
- [`last_trace()`](https://rlang.r-lib.org/dev/reference/last_error.md)
...
- [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) now
  respects the base R global option,
...
- [`expr_label()`](https://rlang.r-lib.org/dev/reference/expr_label.md)
  now has back-compatibility with respect to changes made by R version
  4.4 and `is.atomic(NULL)`
...
- [`englue()`](https://rlang.r-lib.org/dev/reference/englue.md) now
  allows omitting `{{`. This is to make it easier to embed in external
...
- [`parse_expr()`](https://rlang.r-lib.org/dev/reference/parse_expr.md)
  and
  [`parse_exprs()`](https://rlang.r-lib.org/dev/reference/parse_expr.md)
  are now faster when `getOption("keep.source")` is `TRUE`
...
- [`dots_splice()`](https://rlang.r-lib.org/dev/reference/dots_splice.md)
  is deprecated. This function was previously in the questioning
  lifecycle stage as we were moving towards the explicit `!!!` splicing
  style.

- [`flatten()`](https://rlang.r-lib.org/dev/reference/flatten.md),
  [`squash()`](https://rlang.r-lib.org/dev/reference/flatten.md), and
  their variants are deprecated in favour of
...
- [`child_env()`](https://rlang.r-lib.org/dev/reference/child_env.md) is
  deprecated in favour of
  [`env()`](https://rlang.r-lib.org/dev/reference/env.md) which has
  supported creating child environments for several years now.

### Main new features

- [`last_error()`](https://rlang.r-lib.org/dev/reference/last_error.md)
  and `options(rlang_backtrace_on_error = "full")` now print the full
...
- [`global_entrace()`](https://rlang.r-lib.org/dev/reference/global_entrace.md)
  and [`entrace()`](https://rlang.r-lib.org/dev/reference/entrace.md)
  now stop entracing warnings and messages after 20 times. This is to
  avoid a large overhead when 100s or 1000s of warnings are signalled in
  a loop ([\#1473](https://github.com/r-lib/rlang/issues/1473)).

- [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md),
  [`warn()`](https://rlang.r-lib.org/dev/reference/abort.md), and
  [`inform()`](https://rlang.r-lib.org/dev/reference/abort.md) gain an
  `.inherit` parameter. This controls whether `parent` is inherited. If
  `FALSE`,
  [`cnd_inherits()`](https://rlang.r-lib.org/dev/reference/cnd_inherits.md)
  and
  [`try_fetch()`](https://rlang.r-lib.org/dev/reference/try_fetch.md) do
...
- [`englue()`](https://rlang.r-lib.org/dev/reference/englue.md) gained
...
- [`enquos()`](https://rlang.r-lib.org/dev/reference/enquo.md) and
  friends gain a `.ignore_null` argument
  ([\#1450](https://github.com/r-lib/rlang/issues/1450)).

- New
  [`env_is_user_facing()`](https://rlang.r-lib.org/dev/reference/env_is_user_facing.md)
...
- Fixed a memory issue that caused excessive duplication in
  [`list2()`](https://rlang.r-lib.org/dev/reference/list2.md) and
  friends ([\#1491](https://github.com/r-lib/rlang/issues/1491)).
...
- [`expr_deparse()`](https://rlang.r-lib.org/dev/reference/expr_print.md)
  now deparses the embrace operator `{{` on a single line
  ([\#1511](https://github.com/r-lib/rlang/issues/1511)).

- [`zap_srcref()`](https://rlang.r-lib.org/dev/reference/zap_srcref.md)
...
- The non-error path of
  [`check_dots_unnamed()`](https://rlang.r-lib.org/dev/reference/check_dots_unnamed.md)
  has been rewritten in C for efficiency
...
- [`englue()`](https://rlang.r-lib.org/dev/reference/englue.md) now
  requires size 1 outputs
  ([\#1492](https://github.com/r-lib/rlang/issues/1492)). This prevents
  surprising errors or inconsistencies when an interpolated input of
  size != 1 makes its way into the glue string.

- [`arg_match()`](https://rlang.r-lib.org/dev/reference/arg_match.md)
  now throws correct error when supplied a missing value or an empty
  vector ([\#1519](https://github.com/r-lib/rlang/issues/1519)).
...
- [`quo_squash()`](https://rlang.r-lib.org/dev/reference/quo_squash.md)
  now squashes quosures in function position
...
- [`obj_address()`](https://rlang.r-lib.org/dev/reference/obj_address.md)
...
- The low-level function
  [`error_call()`](https://rlang.r-lib.org/dev/reference/format_error_call.md)
  is now exported
...
- Supplying a frame environment to the `call` argument of
  [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) now causes
  the corresponding function call in the backtrace to be highlighted.
...
- `abort(message = )` can now be a function. In this case, it is stored
  ...
  [`cnd_header()`](https://rlang.r-lib.org/dev/reference/cnd_message.md)
...
- New
  [`reset_warning_verbosity()`](https://rlang.r-lib.org/dev/reference/abort.md)
  and
  [`reset_message_verbosity()`](https://rlang.r-lib.org/dev/reference/abort.md)
  functions. These reset the verbosity of messages signalled with
  [`warn()`](https://rlang.r-lib.org/dev/reference/abort.md) and
  [`inform()`](https://rlang.r-lib.org/dev/reference/abort.md) with the
  `.frequency` argument. This is useful for testing verbosity in your
  package ([\#1414](https://github.com/r-lib/rlang/issues/1414)).

- [`check_dots_empty()`](https://rlang.r-lib.org/dev/reference/check_dots_empty.md)
...
- New
  [`env_coalesce()`](https://rlang.r-lib.org/dev/reference/env_clone.md)
...
- [`arg_match()`](https://rlang.r-lib.org/dev/reference/arg_match.md)
  and
  [`arg_match0()`](https://rlang.r-lib.org/dev/reference/arg_match.md)
  now mention the correct call in case of type error
  ([\#1388](https://github.com/r-lib/rlang/issues/1388)).

- [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) and
  [`inform()`](https://rlang.r-lib.org/dev/reference/abort.md) now print
...
- Source references in backtraces and
  [`last_error()`](https://rlang.r-lib.org/dev/reference/last_error.md)/[`last_trace()`](https://rlang.r-lib.org/dev/reference/last_error.md)
...
- [`env_binding_are_active()`](https://rlang.r-lib.org/dev/reference/env_binding_are_active.md)
  no longer accidentally triggers active bindings
  ([\#1376](https://github.com/r-lib/rlang/issues/1376)).

- Fixed bug in
  [`quo_squash()`](https://rlang.r-lib.org/dev/reference/quo_squash.md)
  with nested quosures containing the missing argument.
...
- [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) and
  friends no longer calls non-existent functions
...
- `abort(parent = NA)` is now supported to indicate an unchained
  rethrow. This helps
  [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) detect the
  condition handling context to create simpler backtraces where this
  context is hidden by default.

- When `parent` is supplied,
  [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) now loops
  over callers to detect the condition handler frame. This makes it
...
- [`is_call()`](https://rlang.r-lib.org/dev/reference/is_call.md) is now
...
- [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) now
  displays errors as fully bulleted lists. Error headers are displayed
  with a `!` prefix. See
  <https://rlang.r-lib.org/reference/topic-condition-customisation.html>
  to customise the display of error messages.

- [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) now
  displays a full chain of messages when errors are chained with the
  `parent` argument. Following this change, you should update dplyr to
  version 1.0.8 to get proper error messages.

- [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) now
  displays function calls in which a message originated by default. We
  have refrained from showing these calls until now to avoid confusing
  messages when an error is thrown from a helper function that isn’t
  relevant to users.

  To help with these cases,
  [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) now takes
  a `call` argument that you can set to
  [`caller_env()`](https://rlang.r-lib.org/dev/reference/stack.md) or
...
- New
  ...
  - Compared to `withCallingHandler()`,
    [`try_fetch()`](https://rlang.r-lib.org/dev/reference/try_fetch.md)
    is able to handle stack overflow errors (this requires R 4.2,
...
- [`call_name()`](https://rlang.r-lib.org/dev/reference/call_name.md)
  now returns `NULL` instead of `"::"` for calls of the form `foo::bar`.

  We’ve noticed some packages do not check for `NULL` results from
  [`call_name()`](https://rlang.r-lib.org/dev/reference/call_name.md).
  Note that many complex calls such as `foo()()`, `foo$bar()` don’t have
  a “name” and cause a `NULL` result. This is why you should always
  check for `NULL` results when using
  [`call_name()`](https://rlang.r-lib.org/dev/reference/call_name.md).

  We’ve added the function
  [`is_call_simple()`](https://rlang.r-lib.org/dev/reference/call_name.md)
...
- [`is_expression()`](https://rlang.r-lib.org/dev/reference/is_expression.md)
  ...
  Consider using
  [`is_call()`](https://rlang.r-lib.org/dev/reference/is_call.md) or
  just remove the expression check. In many cases it is fine letting all
...
- If a string is supplied to
  [`as_function()`](https://rlang.r-lib.org/dev/reference/as_function.md)
...
- [`with_handlers()`](https://rlang.r-lib.org/dev/reference/with_handlers.md),
  [`call_fn()`](https://rlang.r-lib.org/dev/reference/call_fn.md), and
  [`friendly_type()`](https://rlang.r-lib.org/dev/reference/friendly_type.md)
  are deprecated.

- The `action` argument of
  [`check_dots_used()`](https://rlang.r-lib.org/dev/reference/check_dots_used.md),
  [`check_dots_unnamed()`](https://rlang.r-lib.org/dev/reference/check_dots_unnamed.md),
  and
  [`check_dots_empty()`](https://rlang.r-lib.org/dev/reference/check_dots_empty.md)
...
- New [`englue()`](https://rlang.r-lib.org/dev/reference/englue.md)
  operator to allow string-embracing outside of dynamic dots
  ([\#1172](https://github.com/r-lib/rlang/issues/1172)).

- New [`data_sym()`](https://rlang.r-lib.org/dev/reference/sym.md) and
...
- [`as_label()`](https://rlang.r-lib.org/dev/reference/as_label.md) now
...
- The `.ignore_empty` argument of
  [`enexprs()`](https://rlang.r-lib.org/dev/reference/defusing-advanced.md)
  and [`enquos()`](https://rlang.r-lib.org/dev/reference/enquo.md) no
  longer treats named arguments supplied through `...` as empty,
  consistently with
...
- [`enquo()`](https://rlang.r-lib.org/dev/reference/enquo.md),
  [`enquos()`](https://rlang.r-lib.org/dev/reference/enquo.md) and
  variants now support numbered dots like `..1`
...
- [`try_fetch()`](https://rlang.r-lib.org/dev/reference/try_fetch.md) is
  a flexible alternative to both
...
- New
  [`global_handle()`](https://rlang.r-lib.org/dev/reference/global_handle.md)
...
- The display of chained errors created with the `parent` argument of
  [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) has been
...
- [`inform()`](https://rlang.r-lib.org/dev/reference/abort.md) and
  [`warn()`](https://rlang.r-lib.org/dev/reference/abort.md) messages
  can now be silenced with the global options `rlib_message_verbosity`
  and `rlib_warning_verbosity`.

- [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) now
  outputs error messages to `stdout` in interactive sessions, following
  the same approach as
  [`inform()`](https://rlang.r-lib.org/dev/reference/abort.md).
...
- Errors, warnings, and messages generated from rlang are now formatted
  ...
  [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md),
  [`warn()`](https://rlang.r-lib.org/dev/reference/abort.md), and
  [`inform()`](https://rlang.r-lib.org/dev/reference/abort.md) are
  called from another namespace than rlang. See
...
- [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md),
  [`warn()`](https://rlang.r-lib.org/dev/reference/abort.md), and
  [`inform()`](https://rlang.r-lib.org/dev/reference/abort.md) gain a
  `body` argument to supply additional bullets in the error message.
...
- rlang conditions now have
  ...
  wrappers around
  [`cnd_message()`](https://rlang.r-lib.org/dev/reference/cnd_message.md).
...
- [`cnd_footer()`](https://rlang.r-lib.org/dev/reference/cnd_message.md)
  now returns the `footer` field by default, if any.

- [`warn()`](https://rlang.r-lib.org/dev/reference/abort.md) and
  [`inform()`](https://rlang.r-lib.org/dev/reference/abort.md) now
  signal conditions of classes `"rlang_warning"` and `"rlang_message"`
  respectively.
...
- The error returned by
  [`last_error()`](https://rlang.r-lib.org/dev/reference/last_error.md)
  is now stored on the search path as the `.Last.error` binding of the
...
- Added
  [`is_error()`](https://rlang.r-lib.org/dev/reference/is_condition.md),
  [`is_warning()`](https://rlang.r-lib.org/dev/reference/is_condition.md),
  and
  [`is_message()`](https://rlang.r-lib.org/dev/reference/is_condition.md)
  predicates ([\#1220](https://github.com/r-lib/rlang/issues/1220)).

- [`interrupt()`](https://rlang.r-lib.org/dev/reference/interrupt.md) no
  longer fails when interrupts are suspended
  ([\#1224](https://github.com/r-lib/rlang/issues/1224)).

- [`warn()`](https://rlang.r-lib.org/dev/reference/abort.md) now
  temporarily sets the `warning.length` global option to the maximum
  value (8170). The default limit (1000 characters) is especially easy
  to hit when the message contains a lot of ANSI escapes, as created by
  the crayon or cli packages
  ([\#1211](https://github.com/r-lib/rlang/issues/1211)).

#### Backtraces

- [`entrace()`](https://rlang.r-lib.org/dev/reference/entrace.md) and
  [`global_entrace()`](https://rlang.r-lib.org/dev/reference/global_entrace.md)
...
- A [`knitr::sew()`](https://rdrr.io/pkg/knitr/man/sew.html) method is
  ...
  [`last_error()`](https://rlang.r-lib.org/dev/reference/last_error.md)
  (the call must occur in a different chunk than the error) and to set
...
- The `rlang_trace_top_env` global option for
  [`trace_back()`](https://rlang.r-lib.org/dev/reference/trace_back.md)
  now detects when backtraces are created within knitr. If the option is
  not set, its default value becomes
...
- [`arg_match()`](https://rlang.r-lib.org/dev/reference/arg_match.md)
  gains a `multiple` argument for cases where zero or several matches
  are allowed ([\#1281](https://github.com/r-lib/rlang/issues/1281)).
...
- [`check_dots_empty()`](https://rlang.r-lib.org/dev/reference/check_dots_empty.md),
  ...
  We have added
  [`check_dots_empty0()`](https://rlang.r-lib.org/dev/reference/check_dots_empty0.md).
...
- New
  [`check_exclusive()`](https://rlang.r-lib.org/dev/reference/check_exclusive.md)
  function to check that only one argument of a set is supplied
  ([\#1261](https://github.com/r-lib/rlang/issues/1261)).

#### R APIs

- [`on_load()`](https://rlang.r-lib.org/dev/reference/on_load.md) and
  [`run_on_load()`](https://rlang.r-lib.org/dev/reference/on_load.md)
  lets you run `.onLoad()` expressions from any file of your package.
  [`on_package_load()`](https://rlang.r-lib.org/dev/reference/on_load.md)
...
- The new predicate
  ...
  - If `is_call_simple(x, ns = TRUE)` is `TRUE`,
    [`call_ns()`](https://rlang.r-lib.org/dev/reference/call_name.md)
    always returns a string.

- [`call_name()`](https://rlang.r-lib.org/dev/reference/call_name.md)
  and [`call_ns()`](https://rlang.r-lib.org/dev/reference/call_name.md)
  now return `NULL` with calls of the form `foo::bar`
  ([\#670](https://github.com/r-lib/rlang/issues/670)).

- New
  [`current_call()`](https://rlang.r-lib.org/dev/reference/stack.md),
  [`caller_call()`](https://rlang.r-lib.org/dev/reference/stack.md), and
  [`frame_call()`](https://rlang.r-lib.org/dev/reference/stack.md)
  accessors. New
  [`frame_fn()`](https://rlang.r-lib.org/dev/reference/stack.md)
  accessor.

- [`env_has()`](https://rlang.r-lib.org/dev/reference/env_has.md) and
  the corresponding C-level function no longer force active bindings
...
- [`zap_srcref()`](https://rlang.r-lib.org/dev/reference/zap_srcref.md)
  now preserves attributes of closures.

- Objects headers (as printed by
  [`last_error()`](https://rlang.r-lib.org/dev/reference/last_error.md),
  [`env_print()`](https://rlang.r-lib.org/dev/reference/env_print.md),
...
- [`env_clone()`](https://rlang.r-lib.org/dev/reference/env_clone.md)
  now properly clones active bindings and avoids forcing promises
...
- `compat-purrr.R` now longer includes `pluck*` helpers; these used a
  ...
  [`as_function()`](https://rlang.r-lib.org/dev/reference/as_function.md)
  so that you can pass short anonymous functions that use `~`
...
- The `.named` argument of
  [`dots_list()`](https://rlang.r-lib.org/dev/reference/list2.md) can
  now be set to `NULL` to give the result default names. With this
  option, fully unnamed inputs produce a fully unnamed result with
  `NULL` names instead of a character vector of minimal `""` names
  ([\#390](https://github.com/r-lib/rlang/issues/390)).

- [`is_named2()`](https://rlang.r-lib.org/dev/reference/is_named.md) is
  a variant of
  [`is_named()`](https://rlang.r-lib.org/dev/reference/is_named.md) that
...
- New [`hash_file()`](https://rlang.r-lib.org/dev/reference/hash.md),
  complementing
  [`hash()`](https://rlang.r-lib.org/dev/reference/hash.md), to generate
  128-bit hashes for the data within a file without loading it into R
  ([\#1134](https://github.com/r-lib/rlang/issues/1134)).

- New
  [`env_cache()`](https://rlang.r-lib.org/dev/reference/env_cache.md)
...
- [`env_get()`](https://rlang.r-lib.org/dev/reference/env_get.md) and
  [`env_get_list()`](https://rlang.r-lib.org/dev/reference/env_get.md)
  gain a `last` argument. Lookup stops in that environment. This can be
...
- New
  ...
  [`call_standardise()`](https://rlang.r-lib.org/dev/reference/call_standardise.md)
...
- Updated
  [`env_print()`](https://rlang.r-lib.org/dev/reference/env_print.md) to
  use
  [`format_error_bullets()`](https://rlang.r-lib.org/dev/reference/format_error_bullets.md)
  and consistent tidyverse style
  ([\#1154](https://github.com/r-lib/rlang/issues/1154)).

- [`set_names()`](https://rlang.r-lib.org/dev/reference/set_names.md)
  now recycles names of size 1 to the size of the input, following the
  tidyverse recycling rules.

- [`is_bare_formula()`](https://rlang.r-lib.org/dev/reference/is_formula.md)
...
- New
  [`is_complex()`](https://rlang.r-lib.org/dev/reference/type-predicates.md)
...
- Fixed a gcc11 warning related to
  [`hash()`](https://rlang.r-lib.org/dev/reference/hash.md)
...
- New [`hash()`](https://rlang.r-lib.org/dev/reference/hash.md) function
  to generate 128-bit hashes for arbitrary R objects using the xxHash
...
- Fixed an issue causing extra empty lines in
  [`inform()`](https://rlang.r-lib.org/dev/reference/abort.md) messages
  with `.frequency`
  ([\#1076](https://github.com/r-lib/rlang/issues/1076),
...
- [`inject()`](https://rlang.r-lib.org/dev/reference/inject.md)
  evaluates its argument with `!!`, `!!!`, and `{{` support.

- New
  [`enquo0()`](https://rlang.r-lib.org/dev/reference/defusing-advanced.md)
  and
  [`enquos0()`](https://rlang.r-lib.org/dev/reference/defusing-advanced.md)
...
- The exit status of is now preserved in non-interactive sessions when
  [`entrace()`](https://rlang.r-lib.org/dev/reference/entrace.md) is
  used as an `options(error = )` handler
...
- [`get_env()`](https://rlang.r-lib.org/dev/reference/get_env.md) now
...
- [`entrace()`](https://rlang.r-lib.org/dev/reference/entrace.md) no
  longer handles non-rlang errors that carry a backtrace. This improves
...
- [`cnd_muffle()`](https://rlang.r-lib.org/dev/reference/cnd_muffle.md)
  now returns `FALSE` instead of failing if the condition is not
  mufflable ([\#1022](https://github.com/r-lib/rlang/issues/1022)).
...
- New
  [`raw_deparse_str()`](https://rlang.r-lib.org/dev/reference/raw_deparse_str.md)
...
- [`env_poke()`](https://rlang.r-lib.org/dev/reference/env_poke.md) now
  supports [`zap()`](https://rlang.r-lib.org/dev/reference/zap.md)
...
- [`env_poke()`](https://rlang.r-lib.org/dev/reference/env_poke.md) has
  been rewritten in C for performance.
...
- [`env_has()`](https://rlang.r-lib.org/dev/reference/env_has.md) is now
  rewritten in C for performance.

- [`dots_list()`](https://rlang.r-lib.org/dev/reference/list2.md) gains
  a `.named` argument for auto-naming dots
...
- [`parse_exprs()`](https://rlang.r-lib.org/dev/reference/parse_expr.md)
  now preserves names
  ([\#808](https://github.com/r-lib/rlang/issues/808)). When a single
  string produces multiple expressions, the names may be useful to
...
- [`arg_match0()`](https://rlang.r-lib.org/dev/reference/arg_match.md)
  ...
  [`arg_match()`](https://rlang.r-lib.org/dev/reference/arg_match.md)
  for use when performance is at a premium
...
- [`set_names()`](https://rlang.r-lib.org/dev/reference/set_names.md),
  [`is_formula()`](https://rlang.r-lib.org/dev/reference/is_formula.md),
  and [`names2()`](https://rlang.r-lib.org/dev/reference/names2.md) are
  now implemented in C for efficiency.
...
- [`arg_match()`](https://rlang.r-lib.org/dev/reference/arg_match.md)
  now detects and suggests possible typos in provided arguments
  ([@jonkeane](https://github.com/jonkeane),
  [\#798](https://github.com/r-lib/rlang/issues/798)).

- [`arg_match()`](https://rlang.r-lib.org/dev/reference/arg_match.md)
  now gives an error if argument is of length greater than 1 and doesn’t
...
- You can now use glue syntax to unquote on the LHS of `:=`. This syntax
  ...
  [`list2()`](https://rlang.r-lib.org/dev/reference/list2.md) and
  [`enquos()`](https://rlang.r-lib.org/dev/reference/enquo.md), and thus
...
- [`warn()`](https://rlang.r-lib.org/dev/reference/abort.md) and
  [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) now check
  that either `class` or `message` was supplied.
  [`inform()`](https://rlang.r-lib.org/dev/reference/abort.md) allows
  sending empty message as it is occasionally useful for building user
  output incrementally.

- [`flatten()`](https://rlang.r-lib.org/dev/reference/flatten.md) fails
  with a proper error when input can’t be flattened
...
- [`cnd_signal()`](https://rlang.r-lib.org/dev/reference/cnd_signal.md)
  ...
  [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) to save
  unhandled errors to
  [`last_error()`](https://rlang.r-lib.org/dev/reference/last_error.md).

- Parsable constants like `NaN` and `NA_integer_` are now deparsed by
  [`expr_deparse()`](https://rlang.r-lib.org/dev/reference/expr_print.md)
  in their parsable form
...
- New
  [`cnd_header()`](https://rlang.r-lib.org/dev/reference/cnd_message.md),
  [`cnd_body()`](https://rlang.r-lib.org/dev/reference/cnd_message.md)
  and
  [`cnd_footer()`](https://rlang.r-lib.org/dev/reference/cnd_message.md)
...
- The reminder to call
  [`last_error()`](https://rlang.r-lib.org/dev/reference/last_error.md)
  is now less confusing thanks to a suggestion by
...
- The functions prefixed in `scoped_` have been renamed to use the more
  ...
  [`scoped_bindings()`](https://rlang.r-lib.org/dev/reference/scoped_interactive.md)
  is now
...
- The `.subclass` argument of
  [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md),
  [`warn()`](https://rlang.r-lib.org/dev/reference/abort.md) and
  [`inform()`](https://rlang.r-lib.org/dev/reference/abort.md) has been
...
- [`inform()`](https://rlang.r-lib.org/dev/reference/abort.md) now
  prints messages to the standard output by default in interactive
  sessions. This makes them appear more like normal output in IDEs such
  as RStudio. In non-interactive sessions, messages are still printed to
  standard error to make it easy to redirect messages when running R
  scripts ([\#852](https://github.com/r-lib/rlang/issues/852)).

- Fixed an error in
  [`trace_back()`](https://rlang.r-lib.org/dev/reference/trace_back.md)
  when the call stack contains a quosured symbol.
...
- New experimental framework for creating bulleted error messages. See
  [`?cnd_message`](https://rlang.r-lib.org/dev/reference/cnd_message.md)
  for the motivation and an overview of the tools we have created to
  support this approach. In particular,
  [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) now takes
...
- [`env_clone()`](https://rlang.r-lib.org/dev/reference/env_clone.md) no
...
- The display of rlang errors derived from parent errors has been
  ...
  [`rlang::last_trace()`](https://rlang.r-lib.org/dev/reference/last_error.md))
  now includes the backtraces of the parent errors.

- [`cnd_signal()`](https://rlang.r-lib.org/dev/reference/cnd_signal.md)
  has improved support for rlang errors created with
  [`error_cnd()`](https://rlang.r-lib.org/dev/reference/cnd.md). It now
...
- rlang errors are no longer formatted and saved through
  ...
  [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md), which is
  useful to delay expensive generation of error messages until display
  time.

- [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) can now be
...
- Fixed an infinite loop in
  [`eval_tidy()`](https://rlang.r-lib.org/dev/reference/eval_tidy.md).
  It occurred when evaluating a quosure that inherits from the mask
  itself.

- [`env_bind()`](https://rlang.r-lib.org/dev/reference/env_bind.md)’s
  performance has been significantly improved by fixing a bug that
  caused values to be repeatedly looked up by name.

- [`cnd_muffle()`](https://rlang.r-lib.org/dev/reference/cnd_muffle.md)
  now checks that a restart exists before invoking it. The restart might
  not exist if the condition is signalled with a different function
  (such as `stop(warning_cnd)`).

- [`trace_length()`](https://rlang.r-lib.org/dev/reference/trace_back.md)
  returns the number of frames in a backtrace.

- Added internal utility
  [`cnd_entrace()`](https://rlang.r-lib.org/dev/reference/entrace.md) to
  add a backtrace to a condition.
...
- Fixed
  [`chr()`](https://rlang.r-lib.org/dev/reference/vector-construction.md)
...
- [`is_bool()`](https://rlang.r-lib.org/dev/reference/scalar-type-predicates.md)
  is a scalar type predicate that checks whether its input is a single
  `TRUE` or `FALSE`. Like
  [`is_string()`](https://rlang.r-lib.org/dev/reference/scalar-type-predicates.md),
...
- [`set_names()`](https://rlang.r-lib.org/dev/reference/set_names.md)
  now names unnamed input vectors before applying a function. The
  following expressions are now equivalent:
...
- You can now pass a character vector as message argument for
  [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md),
  [`warn()`](https://rlang.r-lib.org/dev/reference/abort.md),
  [`inform()`](https://rlang.r-lib.org/dev/reference/abort.md), and
  [`signal()`](https://rlang.r-lib.org/dev/reference/abort.md). The
  vector is collapsed to a single string with a `"\n"` newline
  separating each element of the input vector
  ([\#744](https://github.com/r-lib/rlang/issues/744)).

- [`maybe_missing()`](https://rlang.r-lib.org/dev/reference/missing_arg.md)
  gains a `default` argument.

- New functions for weak references:
  [`new_weakref()`](https://rlang.r-lib.org/dev/reference/new_weakref.md),
...
- The performance of
  [`exec()`](https://rlang.r-lib.org/dev/reference/exec.md) has been
  improved. It is now on the same order of performance as
  [`do.call()`](https://rdrr.io/r/base/do.call.html), though slightly
  slower.

- [`call2()`](https://rlang.r-lib.org/dev/reference/call2.md) now uses
  the new
  [`pairlist2()`](https://rlang.r-lib.org/dev/reference/pairlist2.md)
...
- [`ns_env()`](https://rlang.r-lib.org/dev/reference/ns_env.md) and
  [`ns_env_name()`](https://rlang.r-lib.org/dev/reference/ns_env.md)
...
- [`fn_fmls()`](https://rlang.r-lib.org/dev/reference/fn_fmls.md) and
...
- The vector constructors like
  [`lgl()`](https://rlang.r-lib.org/dev/reference/vector-construction.md)
  or
  [`new_logical()`](https://rlang.r-lib.org/dev/reference/new-vector.md)
  are now in the questioning stage. They are likely to be moved to the
  vctrs package at some point. Same for the missing values shortcuts
  like `na_lgl`.

- [`as_logical()`](https://rlang.r-lib.org/dev/reference/vector-coercion.md),
  [`as_integer()`](https://rlang.r-lib.org/dev/reference/vector-coercion.md),
  etc have been soft-deprecated in favour of
  [`vctrs::vec_cast()`](https://vctrs.r-lib.org/reference/vec_cast.html).

- [`type_of()`](https://rlang.r-lib.org/dev/reference/type_of.md),
  [`switch_type()`](https://rlang.r-lib.org/dev/reference/switch_type.md),
  [`coerce_type()`](https://rlang.r-lib.org/dev/reference/switch_type.md),
...
[`as_name()`](https://rlang.r-lib.org/dev/reference/as_name.md) which
are meant to replace
[`quo_name()`](https://rlang.r-lib.org/dev/reference/quo_label.md) in
the future. Finally, a bunch of deparsing issues have been fixed.

### Backtrace fixes

- New [`entrace()`](https://rlang.r-lib.org/dev/reference/entrace.md)
...
- [`catch_cnd()`](https://rlang.r-lib.org/dev/reference/catch_cnd.md)
  gains a `classes` argument to specify which classes of condition to
  catch. It returns `NULL` if the expected condition could not be caught
...
The new
[`as_label()`](https://rlang.r-lib.org/dev/reference/as_label.md) and
[`as_name()`](https://rlang.r-lib.org/dev/reference/as_name.md)
functions should be used instead of
[`quo_name()`](https://rlang.r-lib.org/dev/reference/quo_label.md) to
...
[`quo_name()`](https://rlang.r-lib.org/dev/reference/quo_label.md)
creates a string is not a well defined operation.

For this reason, we are replacing
[`quo_name()`](https://rlang.r-lib.org/dev/reference/quo_label.md) with
two new functions that have more clearly defined purposes, and hopefully
better names reflecting those purposes. Use
[`as_label()`](https://rlang.r-lib.org/dev/reference/as_label.md) to
transform any object to a short human-readable description, and
[`as_name()`](https://rlang.r-lib.org/dev/reference/as_name.md) to
extract names from (possibly quosured) symbols.
...
We expect
[`as_label()`](https://rlang.r-lib.org/dev/reference/as_label.md) to
gain additional parameters in the future, for example to control the
maximum width of a label. The way an object is labelled is thus subject
to change.

On the other hand,
[`as_name()`](https://rlang.r-lib.org/dev/reference/as_name.md)
transforms symbols back to a string in a well defined manner. Unlike
[`as_label()`](https://rlang.r-lib.org/dev/reference/as_label.md),
[`as_name()`](https://rlang.r-lib.org/dev/reference/as_name.md)
guarantees the roundtrip symbol -\> string -\> symbol.

In general, if you don’t know for sure what kind of object you’re
dealing with (a call, a symbol, an unquoted constant), use
[`as_label()`](https://rlang.r-lib.org/dev/reference/as_label.md) and
make no assumption about the resulting string. If you know you have a
symbol and need the name of the object it refers to, use
[`as_name()`](https://rlang.r-lib.org/dev/reference/as_name.md). For
instance, use
[`as_label()`](https://rlang.r-lib.org/dev/reference/as_label.md) with
...
Note that
[`quo_name()`](https://rlang.r-lib.org/dev/reference/quo_label.md) will
only be soft-deprecated at the next major version of rlang (0.4.0). At
this point, it will start issuing once-per-session warnings in scripts,
but not in packages. It will then be deprecated in yet another major
version, at which point it will issue once-per-session warnings in
...
- New
  ...
  [`with_interactive()`](https://rlang.r-lib.org/dev/reference/is_interactive.md)
  and
  [`scoped_interactive()`](https://rlang.r-lib.org/dev/reference/scoped_interactive.md)
...
- New [`done()`](https://rlang.r-lib.org/dev/reference/done.md) function
  to box a value. Done boxes are sentinels to indicate early termination
  of a loop or computation. For instance, it will be used in the purrr
  package to allow users to shortcircuit a reduction or accumulation.

- [`new_box()`](https://rlang.r-lib.org/dev/reference/box.md) now
  accepts additional attributes passed to
...
- New [`call_ns()`](https://rlang.r-lib.org/dev/reference/call_name.md)
...
- [`expr_print()`](https://rlang.r-lib.org/dev/reference/expr_print.md)
  now handles `[` and `[[` operators correctly, and deparses
...
- [`as_closure()`](https://rlang.r-lib.org/dev/reference/as_closure.md)
...
- [`as_closure()`](https://rlang.r-lib.org/dev/reference/as_closure.md)
  now supports both base-style (`e1` and `e2`) and purrr-style (`.x` and
  `.y`) arguments with binary primitives.

- [`exec()`](https://rlang.r-lib.org/dev/reference/exec.md) takes `.fn`
  as first argument instead of `f`, for consistency with other rlang
  functions.
...
- [`quo_text()`](https://rlang.r-lib.org/dev/reference/quo_label.md) now
  ...
  [`quo_text()`](https://rlang.r-lib.org/dev/reference/quo_label.md)
  tends to be used for converting symbols to strings.
  [`quo_text()`](https://rlang.r-lib.org/dev/reference/quo_label.md) and
  [`quo_name()`](https://rlang.r-lib.org/dev/reference/quo_label.md)
  should not be used for this purpose because they are general purpose
...
- [`exprs()`](https://rlang.r-lib.org/dev/reference/defusing-advanced.md)
  no longer flattens quosures. `exprs(!!!quos(x, y))` is now equivalent
  to `quos(x, y)`.

- The sentinel for removing arguments in
  [`call_modify()`](https://rlang.r-lib.org/dev/reference/call_modify.md)
  has been changed from `NULL` to
  [`zap()`](https://rlang.r-lib.org/dev/reference/zap.md). This breaking
...
- Taking the
  [`env_parent()`](https://rlang.r-lib.org/dev/reference/env_parent.md)
...
- [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) now
  records backtraces automatically in the error object. Errors thrown
  with [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md)
  ...
  with
  [`trace_back()`](https://rlang.r-lib.org/dev/reference/trace_back.md))
  are printed in a simplified form by default that removes
  implementation details from the backtrace. To see the full backtrace,
  call `summary(rlang::last_error())`.

  [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) also gains
  a `parent` argument. This is meant for situations where you’re calling
  a low level API (to download a file, parse a JSON file, etc) and would
  like to intercept errors with
  [`base::tryCatch()`](https://rdrr.io/r/base/conditions.html) or
  [`rlang::with_handlers()`](https://rlang.r-lib.org/dev/reference/with_handlers.md)
  and rethrow them with a high-level message. Call
  [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) with the
  ...
  thrown with
  [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md). When
  that’s not the case, you can call the low-level function within
...
- New
  ...
  [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) (see
  below).
...
- Errors thrown with
  [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) now embed
  a backtrace in the condition object. It is no longer necessary to
  record a trace with a calling handler for such errors.
...
- Unhandled errors thrown by
  [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) are now
...
- New experimental option `rlang__backtrace_on_error` to display
  ...
  [`?rlang::abort`](https://rlang.r-lib.org/dev/reference/abort.md) for
  supported options.

- The new [`signal()`](https://rlang.r-lib.org/dev/reference/abort.md)
  function completes the
  [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md),
  [`warn()`](https://rlang.r-lib.org/dev/reference/abort.md) and
  [`inform()`](https://rlang.r-lib.org/dev/reference/abort.md) family.
  It creates and signals a bare condition.

- New
  [`interrupt()`](https://rlang.r-lib.org/dev/reference/interrupt.md)
  function to simulate an user interrupt from R code.

- [`cnd_signal()`](https://rlang.r-lib.org/dev/reference/cnd_signal.md)
  now dispatches messages, warnings, errors and interrupts to the
  relevant signalling functions
...
- New [`cnd_type()`](https://rlang.r-lib.org/dev/reference/cnd_type.md)
...
- [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md),
  [`warn()`](https://rlang.r-lib.org/dev/reference/abort.md) and
  [`inform()`](https://rlang.r-lib.org/dev/reference/abort.md) now
  accepts metadata with `...`. The data are stored in the condition and
  can be examined by user handlers.
...
- The input types of `!!!` have been standardised. `!!!` is generally
  ...
  [`list2()`](https://rlang.r-lib.org/dev/reference/list2.md) and in
  quoting functions. `!!!` accepts these types:
...
- [`dots_list()`](https://rlang.r-lib.org/dev/reference/list2.md),
  [`enexprs()`](https://rlang.r-lib.org/dev/reference/defusing-advanced.md)
  and [`enquos()`](https://rlang.r-lib.org/dev/reference/enquo.md) gain
  a `.homonyms` argument to control how to treat arguments with the same
...
- [`enexprs()`](https://rlang.r-lib.org/dev/reference/defusing-advanced.md)
  and [`enquos()`](https://rlang.r-lib.org/dev/reference/enquo.md) now
  support `.ignore_empty = "all"` with named arguments as well
  ([\#414](https://github.com/r-lib/rlang/issues/414)).

- [`dots_list()`](https://rlang.r-lib.org/dev/reference/list2.md) gains
  a `.preserve_empty` argument. When `TRUE`, empty arguments are stored
  as missing arguments (see
  [`?missing_arg`](https://rlang.r-lib.org/dev/reference/missing_arg.md)).

- [`dots_list()`](https://rlang.r-lib.org/dev/reference/list2.md),
  [`enexprs()`](https://rlang.r-lib.org/dev/reference/defusing-advanced.md)
  and [`enquos()`](https://rlang.r-lib.org/dev/reference/enquo.md) gain
  a `.check_assign` argument. When `TRUE`, a warning is issued when a
  `<-` call is detected in `...`. No warning is issued if the assignment
  is wrapped in brackets like `{ a <- 1 }`. The warning lets users know
...
- [`as_data_pronoun()`](https://rlang.r-lib.org/dev/reference/as_data_mask.md)
...
- New functions
  [`new_quosures()`](https://rlang.r-lib.org/dev/reference/new_quosures.md)
  and
  [`as_quosures()`](https://rlang.r-lib.org/dev/reference/new_quosures.md)
...
- [`env()`](https://rlang.r-lib.org/dev/reference/env.md) now treats a
  single unnamed argument as the parent of the new environment.
  Consequently,
  [`child_env()`](https://rlang.r-lib.org/dev/reference/child_env.md) is
  now superfluous and is now in questioning life cycle.

- New [`current_env()`](https://rlang.r-lib.org/dev/reference/stack.md)
  and [`current_fn()`](https://rlang.r-lib.org/dev/reference/stack.md)
  functions to retrieve the current environment or the function being
  evaluated. They are equivalent to
...
- [`env_get()`](https://rlang.r-lib.org/dev/reference/env_get.md) and
  [`env_get_list()`](https://rlang.r-lib.org/dev/reference/env_get.md)
  gain a `default` argument to provide a default value for non-existing
  bindings.
...
- The new function
  ...
  returns the name of an environment. It always adds the “namespace:”
  prefix to namespace names. It returns “global” instead of “.GlobalEnv”
  or “R_GlobalEnv”, “empty” instead of “R_EmptyEnv”. The companion
  [`env_label()`](https://rlang.r-lib.org/dev/reference/env_name.md) is
  like [`env_name()`](https://rlang.r-lib.org/dev/reference/env_name.md)
  but returns the memory address for anonymous environments.

- [`env_parents()`](https://rlang.r-lib.org/dev/reference/env_parent.md)
  now returns a named list. The names are taken with
  [`env_name()`](https://rlang.r-lib.org/dev/reference/env_name.md).

- [`env_parents()`](https://rlang.r-lib.org/dev/reference/env_parent.md)
  and
  [`env_tail()`](https://rlang.r-lib.org/dev/reference/env_parent.md)
  now stop at the global environment by default. This can be changed
  with the `last` argument. The empty environment is always a stopping
...
- New predicates
  [`env_binding_are_active()`](https://rlang.r-lib.org/dev/reference/env_binding_are_active.md)
  and
  [`env_binding_are_lazy()`](https://rlang.r-lib.org/dev/reference/env_binding_are_active.md)
  detect the kind of bindings in an environment.

- [`env_binding_lock()`](https://rlang.r-lib.org/dev/reference/env_binding_lock.md)
  and
  [`env_binding_unlock()`](https://rlang.r-lib.org/dev/reference/env_binding_lock.md)
  allows to lock and unlock multiple bindings. The predicate
  [`env_binding_are_locked()`](https://rlang.r-lib.org/dev/reference/env_binding_lock.md)
  tests if bindings are locked.

- [`env_lock()`](https://rlang.r-lib.org/dev/reference/env_lock.md) and
  [`env_is_locked()`](https://rlang.r-lib.org/dev/reference/env_lock.md)
...
- [`is_scoped()`](https://rlang.r-lib.org/dev/reference/scoped_env.md)
  has been soft-deprecated and renamed to
  [`is_attached()`](https://rlang.r-lib.org/dev/reference/search_envs.md).
...
- [`env_bind()`](https://rlang.r-lib.org/dev/reference/env_bind.md) now
...
- The `inherit` argument of
  [`env_get()`](https://rlang.r-lib.org/dev/reference/env_get.md) and
  [`env_get_list()`](https://rlang.r-lib.org/dev/reference/env_get.md)
  has changed position. It now comes after `default`.

- [`scoped_bindings()`](https://rlang.r-lib.org/dev/reference/scoped_interactive.md)
  and
  [`with_bindings()`](https://rlang.r-lib.org/dev/reference/local_bindings.md)
  can now be called without bindings.

- [`env_clone()`](https://rlang.r-lib.org/dev/reference/env_clone.md)
  now recreates active bindings correctly.

- [`env_get()`](https://rlang.r-lib.org/dev/reference/env_get.md) now
...
- [`env_print()`](https://rlang.r-lib.org/dev/reference/env_print.md)
  calls [`get_env()`](https://rlang.r-lib.org/dev/reference/get_env.md)
  on its argument, making it easier to see the environment of closures
  and quosures ([\#567](https://github.com/r-lib/rlang/issues/567)).
...
- [`is_call()`](https://rlang.r-lib.org/dev/reference/is_call.md) now
...
- [`call_modify()`](https://rlang.r-lib.org/dev/reference/call_modify.md)
  ...
  [`missing_arg()`](https://rlang.r-lib.org/dev/reference/missing_arg.md)
  to add a missing argument to a call. This is possible thanks to the
  new `.preserve_empty` option of
  [`dots_list()`](https://rlang.r-lib.org/dev/reference/list2.md).
...
- New function [`zap()`](https://rlang.r-lib.org/dev/reference/zap.md)
  returns a sentinel that instructs functions like
  [`env_bind()`](https://rlang.r-lib.org/dev/reference/env_bind.md) or
  [`call_modify()`](https://rlang.r-lib.org/dev/reference/call_modify.md)
  that objects are to be removed.

- New function
  [`rep_named()`](https://rlang.r-lib.org/dev/reference/rep_along.md)
  repeats value along a character vector of names.

- New function [`exec()`](https://rlang.r-lib.org/dev/reference/exec.md)
  is a simpler replacement to
  [`invoke()`](https://rlang.r-lib.org/dev/reference/invoke.md)
  ([\#536](https://github.com/r-lib/rlang/issues/536)).
  [`invoke()`](https://rlang.r-lib.org/dev/reference/invoke.md) has been
  soft-deprecated.

- Lambda functions created from formulas with
  [`as_function()`](https://rlang.r-lib.org/dev/reference/as_function.md)
  are now classed. Use
  [`is_lambda()`](https://rlang.r-lib.org/dev/reference/as_function.md)
...
- [`are_na()`](https://rlang.r-lib.org/dev/reference/are_na.md) now
  requires atomic vectors
  ([\#558](https://github.com/r-lib/rlang/issues/558)).

- The operator `%@%` has now a replacement version to update attributes
  of an object ([\#207](https://github.com/r-lib/rlang/issues/207)).

- [`fn_body()`](https://rlang.r-lib.org/dev/reference/fn_body.md) always
...
- [`is_bare_integerish()`](https://rlang.r-lib.org/dev/reference/is_integerish.md)
  and
  [`is_scalar_integerish()`](https://rlang.r-lib.org/dev/reference/is_integerish.md)
  gain a `finite` argument for consistency with
  [`is_integerish()`](https://rlang.r-lib.org/dev/reference/is_integerish.md).

- [`flatten_if()`](https://rlang.r-lib.org/dev/reference/flatten.md) and
  [`squash_if()`](https://rlang.r-lib.org/dev/reference/flatten.md) now
  handle primitive functions like
  [`base::is.list()`](https://rdrr.io/r/base/list.html) as predicates.

- [`is_symbol()`](https://rlang.r-lib.org/dev/reference/is_symbol.md)
  now accepts a character vector of names to mach the symbol against.

- [`parse_exprs()`](https://rlang.r-lib.org/dev/reference/parse_expr.md)
  and
  [`parse_quos()`](https://rlang.r-lib.org/dev/reference/parse_expr.md)
  now support character vectors. Note that the output may be longer than
  the input as each string may yield multiple expressions (such as
  `"foo; bar"`).

- [`parse_quos()`](https://rlang.r-lib.org/dev/reference/parse_expr.md)
  now adds the `quosures` class to its output.
...
- Quosure lists returned by
  [`quos()`](https://rlang.r-lib.org/dev/reference/defusing-advanced.md)
  and [`enquos()`](https://rlang.r-lib.org/dev/reference/enquo.md) now
  have “list-of” behaviour: the types of new elements are checked when
  adding objects to the list. Consequently, assigning non-quosure
  objects to quosure lists is now soft-deprecated. Please coerce to a
  bare list with [`as.list()`](https://rdrr.io/r/base/list.html)
  beforehand.

- [`as_quosure()`](https://rlang.r-lib.org/dev/reference/new_quosure.md)
  now requires an explicit environment for symbols and calls. This
  should typically be the environment in which the expression was
  created.
...
- Using [`get_env()`](https://rlang.r-lib.org/dev/reference/get_env.md)
  without supplying an environment is now soft-deprecated. Please use
  [`current_env()`](https://rlang.r-lib.org/dev/reference/stack.md) to
...
- The `new_vector_along()` family is soft-deprecated because these
  ...
  [`rep_along()`](https://rlang.r-lib.org/dev/reference/rep_along.md) or
  [`rep_named()`](https://rlang.r-lib.org/dev/reference/rep_along.md)
...
- Passing environment wrappers like formulas or functions to `env_`
  ...
  [`env_depth()`](https://rlang.r-lib.org/dev/reference/env_depth.md),
  [`env_poke_parent()`](https://rlang.r-lib.org/dev/reference/get_env.md),
  `env_parent<-`,
  [`env_tail()`](https://rlang.r-lib.org/dev/reference/env_parent.md),
  [`set_env()`](https://rlang.r-lib.org/dev/reference/get_env.md),
  [`env_clone()`](https://rlang.r-lib.org/dev/reference/env_clone.md),
  [`env_inherits()`](https://rlang.r-lib.org/dev/reference/env_inherits.md),
  [`env_bind()`](https://rlang.r-lib.org/dev/reference/env_bind.md),
  [`scoped_bindings()`](https://rlang.r-lib.org/dev/reference/scoped_interactive.md),
  [`with_bindings()`](https://rlang.r-lib.org/dev/reference/local_bindings.md),
  [`env_poke()`](https://rlang.r-lib.org/dev/reference/env_poke.md),
  [`env_has()`](https://rlang.r-lib.org/dev/reference/env_has.md),
  [`env_get()`](https://rlang.r-lib.org/dev/reference/env_get.md),
  [`env_names()`](https://rlang.r-lib.org/dev/reference/env_names.md),
  `env_bind_exprs()` and `env_bind_fns()`.

- [`cnd_signal()`](https://rlang.r-lib.org/dev/reference/cnd_signal.md)
  now always installs a muffling restart for non-critical conditions.
...
- Calling [`UQ()`](https://rlang.r-lib.org/dev/reference/UQ.md) and
  [`UQS()`](https://rlang.r-lib.org/dev/reference/UQ.md) with the rlang
  ...
  [`UQ()`](https://rlang.r-lib.org/dev/reference/UQ.md) and
  [`UQS()`](https://rlang.r-lib.org/dev/reference/UQ.md) can still be
  used for now.
...
- The experimental function `rst_muffle()` is now defunct. Please use
  ...
  [`cnd_muffle()`](https://rlang.r-lib.org/dev/reference/cnd_muffle.md)
  is not generic. It is marked as a calling handler and thus can be
  passed directly to
  [`with_handlers()`](https://rlang.r-lib.org/dev/reference/with_handlers.md)
...
- Modifying a condition with
  [`cnd_signal()`](https://rlang.r-lib.org/dev/reference/cnd_signal.md)
  is defunct. In addition, creating a condition with
  [`cnd_signal()`](https://rlang.r-lib.org/dev/reference/cnd_signal.md)
  is soft-deprecated, please use the new function \[signal()\] instead.
...
- [`flatten()`](https://rlang.r-lib.org/dev/reference/flatten.md),
  [`squash()`](https://rlang.r-lib.org/dev/reference/flatten.md) and
  their atomic variants are now in the questioning lifecycle stage. They
  have slightly different semantics than the flattening functions in
  purrr and we are currently rethinking our approach to flattening with
  the new typing facilities of the vctrs package.
...
- [`enquo()`](https://rlang.r-lib.org/dev/reference/enquo.md) works in
  magrittr pipes: `mtcars %>% select(!!enquo(var))`.

- [`enquos()`](https://rlang.r-lib.org/dev/reference/enquo.md) is a
  variant of
  [`quos()`](https://rlang.r-lib.org/dev/reference/defusing-advanced.md)
...
- The backend for
  ...
  [`dots_list()`](https://rlang.r-lib.org/dev/reference/list2.md), etc
  ...
  [`enexpr()`](https://rlang.r-lib.org/dev/reference/defusing-advanced.md)
  and [`enquo()`](https://rlang.r-lib.org/dev/reference/enquo.md) more
  efficient as well.
...
- New [`enquos()`](https://rlang.r-lib.org/dev/reference/enquo.md)
  function to capture arguments. It treats `...` the same way as
  [`quos()`](https://rlang.r-lib.org/dev/reference/defusing-advanced.md)
  but can also capture named arguments just like
  [`enquo()`](https://rlang.r-lib.org/dev/reference/enquo.md), i.e. one
  level up. By comparison `quos(arg)` only captures the name `arg`
  rather than the expression supplied to the `arg` argument.

  In addition,
  [`enexprs()`](https://rlang.r-lib.org/dev/reference/defusing-advanced.md)
  is like [`enquos()`](https://rlang.r-lib.org/dev/reference/enquo.md)
  but like
  [`exprs()`](https://rlang.r-lib.org/dev/reference/defusing-advanced.md)
  it returns bare expressions. And
  [`ensyms()`](https://rlang.r-lib.org/dev/reference/defusing-advanced.md)
  expects strings or symbols.

- It is now possible to use
  [`enquo()`](https://rlang.r-lib.org/dev/reference/enquo.md) within a
  magrittr pipe:
  ...
  [`enquo()`](https://rlang.r-lib.org/dev/reference/enquo.md) now also
...
- [`quo_expr()`](https://rlang.r-lib.org/dev/reference/quo_expr.md) has
  been renamed to
  [`quo_squash()`](https://rlang.r-lib.org/dev/reference/quo_squash.md)
  in order to better reflect that it is a lossy operation that flattens
  all nested quosures.
...
- Functions taking dots with
  [`list2()`](https://rlang.r-lib.org/dev/reference/list2.md) or
  [`dots_list()`](https://rlang.r-lib.org/dev/reference/list2.md) now
...
- Quasiquotation now supports `!!` and `!!!` as functional forms:
  ...
  [`UQ()`](https://rlang.r-lib.org/dev/reference/UQ.md) and
  [`UQS()`](https://rlang.r-lib.org/dev/reference/UQ.md). We are now
...
- New getters and setters for quosures:
  ...
  [`quo_set_expr()`](https://rlang.r-lib.org/dev/reference/quosure-tools.md),
  and
  [`quo_set_env()`](https://rlang.r-lib.org/dev/reference/quosure-tools.md).
  Compared to
  [`get_expr()`](https://rlang.r-lib.org/dev/reference/set_expr.md) etc,
  these accessors only work on quosures and are slightly more efficient.

- [`quo_is_symbol()`](https://rlang.r-lib.org/dev/reference/quosure-tools.md)
  and
  [`quo_is_call()`](https://rlang.r-lib.org/dev/reference/quosure-tools.md)
  now take the same set of arguments as
  [`is_symbol()`](https://rlang.r-lib.org/dev/reference/is_symbol.md)
  and [`is_call()`](https://rlang.r-lib.org/dev/reference/is_call.md).
...
- [`cnd_signal()`](https://rlang.r-lib.org/dev/reference/cnd_signal.md)
  and `cnd_abort()` now accept character vectors to create typed
  conditions with several S3 subclasses.

- [`is_condition()`](https://rlang.r-lib.org/dev/reference/is_condition.md)
  is now properly exported.

- Condition signallers such as
  [`cnd_signal()`](https://rlang.r-lib.org/dev/reference/cnd_signal.md)
  and [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) now
  accept a call depth as `call` arguments. This allows plucking a call
  from further up the call stack
...
- [`is_namespace()`](https://rlang.r-lib.org/dev/reference/is_namespace.md)
...
- New functions
  [`inherits_any()`](https://rlang.r-lib.org/dev/reference/inherits_any.md),
  [`inherits_all()`](https://rlang.r-lib.org/dev/reference/inherits_any.md),
  and
  [`inherits_only()`](https://rlang.r-lib.org/dev/reference/inherits_any.md).
...
- New function experimental function
  ...
  [`as_utf8_character()`](https://rlang.r-lib.org/dev/reference/as_utf8_character.md)
  now translates those as well. ([@krlmlr](https://github.com/krlmlr))

- [`expr_label()`](https://rlang.r-lib.org/dev/reference/expr_label.md)
  now supports quoted function definition calls
...
- [`is_symbol()`](https://rlang.r-lib.org/dev/reference/is_symbol.md)
  gains a `name` argument to check that that the symbol name matches a
  string ([\#287](https://github.com/r-lib/rlang/issues/287)).
...
- New `rlang_box` class. Its purpose is similar to the `AsIs` class from
  ...
  scalar list. Use
  [`new_box()`](https://rlang.r-lib.org/dev/reference/box.md) to create
  a boxed value,
  [`is_box()`](https://rlang.r-lib.org/dev/reference/box.md) to test for
  a boxed value, and
  [`unbox()`](https://rlang.r-lib.org/dev/reference/box.md) to unbox it.
  [`new_box()`](https://rlang.r-lib.org/dev/reference/box.md) and
  [`is_box()`](https://rlang.r-lib.org/dev/reference/box.md) accept
  optional subclass.

- The vector constructors such as
  [`new_integer()`](https://rlang.r-lib.org/dev/reference/new-vector.md),
...
- When nested quosures are evaluated with
  [`eval_tidy()`](https://rlang.r-lib.org/dev/reference/eval_tidy.md),
  the `.env` pronoun now correctly refers to the current quosure under
...
- Fixed a performance bug in
  [`set_names()`](https://rlang.r-lib.org/dev/reference/set_names.md)
  that caused a full copy of the vector names
...
- The particle “lang” has been renamed to “call”:
  ...
  - [`lang()`](https://rlang.r-lib.org/dev/reference/lang.md) has been
    renamed to
    [`call2()`](https://rlang.r-lib.org/dev/reference/call2.md).
  - `new_language()` has ben renamed to
    [`new_call()`](https://rlang.r-lib.org/dev/reference/new_call.md).
  - [`is_lang()`](https://rlang.r-lib.org/dev/reference/is_lang.md) has
    been renamed to
    [`is_call()`](https://rlang.r-lib.org/dev/reference/is_call.md). We
...
- [`UQ()`](https://rlang.r-lib.org/dev/reference/UQ.md),
  [`UQS()`](https://rlang.r-lib.org/dev/reference/UQ.md) and `:=` now
...
- [`expr_interp()`](https://rlang.r-lib.org/dev/reference/expr_interp.md)
...
- `new_cnd()` is now
  [`cnd()`](https://rlang.r-lib.org/dev/reference/cnd.md) for
  consistency with other constructors. Also, `cnd_error()`,
  `cnd_warning()` and
  [`cnd_message()`](https://rlang.r-lib.org/dev/reference/cnd_message.md)
  are now [`error_cnd()`](https://rlang.r-lib.org/dev/reference/cnd.md),
  [`warning_cnd()`](https://rlang.r-lib.org/dev/reference/cnd.md) and
  [`message_cnd()`](https://rlang.r-lib.org/dev/reference/cnd.md) to
  follow our naming scheme according to which the type of output is a
  suffix rather than a prefix.

- [`is_node()`](https://rlang.r-lib.org/dev/reference/is_pairlist.md)
  now returns `TRUE` for calls as well and
  [`is_pairlist()`](https://rlang.r-lib.org/dev/reference/is_pairlist.md)
  does not return `TRUE` for `NULL` objects. Use
  [`is_node_list()`](https://rlang.r-lib.org/dev/reference/is_pairlist.md)
  to determine whether an object either of type `pairlist` or `NULL`.
  Note that all these functions are still experimental.

- [`set_names()`](https://rlang.r-lib.org/dev/reference/set_names.md) no
...
- Calling the functional forms of unquote operators with the rlang
  ...
  [`UQ()`](https://rlang.r-lib.org/dev/reference/UQ.md) and
  [`UQS()`](https://rlang.r-lib.org/dev/reference/UQ.md) are not
  function calls so it does not make sense to namespace them. Supporting
...
- We are now questioning
  [`UQ()`](https://rlang.r-lib.org/dev/reference/UQ.md) and
  [`UQS()`](https://rlang.r-lib.org/dev/reference/UQ.md) as functional
  forms of `!!`. If `!!` and `!!!` were native R operators, they would
  parse to the functional calls
  [`` `!!`() ``](https://rlang.r-lib.org/dev/reference/injection-operator.md)
  and
  [`` `!!!`() ``](https://rlang.r-lib.org/dev/reference/splice-operator.md).
  ...
  deprecate [`UQ()`](https://rlang.r-lib.org/dev/reference/UQ.md) and
  [`UQS()`](https://rlang.r-lib.org/dev/reference/UQ.md) in the future.
  In any case we recommend using the new functional forms.

- `parse_quosure()` and `parse_quosures()` are soft-deprecated in favour
  of
  [`parse_quo()`](https://rlang.r-lib.org/dev/reference/parse_expr.md)
  and
  [`parse_quos()`](https://rlang.r-lib.org/dev/reference/parse_expr.md).
...
- Using [`f_rhs()`](https://rlang.r-lib.org/dev/reference/f_rhs.md) and
  [`f_env()`](https://rlang.r-lib.org/dev/reference/f_rhs.md) on
  quosures is soft-deprecated. The fact that quosures are formulas is an
...
- [`quo_expr()`](https://rlang.r-lib.org/dev/reference/quo_expr.md) is
  soft-deprecated in favour of
  [`quo_squash()`](https://rlang.r-lib.org/dev/reference/quo_squash.md).
  [`quo_expr()`](https://rlang.r-lib.org/dev/reference/quo_expr.md) was
  a misnomer because it implied that it was a mere expression accessor
  for quosures whereas it was really a lossy operation that squashed all
  nested quosures.

- With the renaming of the `lang` particle to `call`, all these
  functions are soft-deprecated:
  [`lang()`](https://rlang.r-lib.org/dev/reference/lang.md),
  [`is_lang()`](https://rlang.r-lib.org/dev/reference/is_lang.md),
...
- [`splice()`](https://rlang.r-lib.org/dev/reference/splice.md) is now
  in questioning stage as it is not needed given the `!!!` operator
  works in functions taking dots with
  [`dots_list()`](https://rlang.r-lib.org/dev/reference/list2.md).

- `lgl_len()`, `int_len()` etc have been soft-deprecated and renamed
  with `new_` prefix,
  e.g. [`new_logical()`](https://rlang.r-lib.org/dev/reference/new-vector.md)
  and
  [`new_integer()`](https://rlang.r-lib.org/dev/reference/new-vector.md).
  This is for consistency with other non-variadic object constructors.

- [`ll()`](https://rlang.r-lib.org/dev/reference/list2.md) is now an
  alias to [`list2()`](https://rlang.r-lib.org/dev/reference/list2.md).
  This is consistent with the new
  [`call2()`](https://rlang.r-lib.org/dev/reference/call2.md)
  constructor for calls.
  [`list2()`](https://rlang.r-lib.org/dev/reference/list2.md) and
  [`call2()`](https://rlang.r-lib.org/dev/reference/call2.md) are
  versions of [`list()`](https://rdrr.io/r/base/list.html) and
  [`call()`](https://rdrr.io/r/base/call.html) that support splicing of
  lists with `!!!`.
  [`ll()`](https://rlang.r-lib.org/dev/reference/list2.md) remains
  around as a shorthand for users who like its conciseness.

- Automatic splicing of lists in vector constructors
  (e.g. [`lgl()`](https://rlang.r-lib.org/dev/reference/vector-construction.md),
  [`chr()`](https://rlang.r-lib.org/dev/reference/vector-construction.md),
...
- New function
  [`is_reference()`](https://rlang.r-lib.org/dev/reference/is_reference.md)
...
- [`eval_tidy()`](https://rlang.r-lib.org/dev/reference/eval_tidy.md) no
...
- [`enquo()`](https://rlang.r-lib.org/dev/reference/enquo.md) now works
...
- The
  [`new_environment()`](https://rlang.r-lib.org/dev/reference/env.md)
  constructor creates a child of the empty environment and takes an
  optional named list of data to populate it. Compared to
  [`env()`](https://rlang.r-lib.org/dev/reference/env.md) and
  [`child_env()`](https://rlang.r-lib.org/dev/reference/child_env.md),
  it is meant to create environments as data structures rather than as
  part of a scope hierarchy.

- The [`new_call()`](https://rlang.r-lib.org/dev/reference/new_call.md)
...
- `mut_` setters like `mut_attrs()` and environment helpers like
  [`env_bind()`](https://rlang.r-lib.org/dev/reference/env_bind.md) and
  [`env_unbind()`](https://rlang.r-lib.org/dev/reference/env_unbind.md)
  now return their (modified) input invisibly. This follows the
  tidyverse convention that functions called primarily for their side
  effects should return their input invisibly.

- [`is_pairlist()`](https://rlang.r-lib.org/dev/reference/is_pairlist.md)
  now returns `TRUE` for `NULL`. We added
  [`is_node()`](https://rlang.r-lib.org/dev/reference/is_pairlist.md) to
...
- [`env()`](https://rlang.r-lib.org/dev/reference/env.md) and
  `env_child()` can now get arguments whose names start with `.`. Prior
  to this fix, these arguments were partial-matching on
  [`env_bind()`](https://rlang.r-lib.org/dev/reference/env_bind.md)’s
  `.env` argument.
