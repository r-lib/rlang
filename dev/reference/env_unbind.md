...
[`env_bind()`](https://rlang.r-lib.org/dev/reference/env_bind.md). Like
[`env_has()`](https://rlang.r-lib.org/dev/reference/env_has.md), it
ignores the parent environments of `env` by default. Set `inherit` to
`TRUE` to track down bindings in parent environments.
