...
[`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) to use cli
to format error messages. This formatting happens lazily, at print-time,
in various places:
...
1.  Make sure
    ...
    is called from your `.onLoad()` hook.
