...
particular [missing
types](https://rlang.r-lib.org/dev/reference/missing.md).
...
in that respect. In contrast the vectorised predicate `are_na()`
requires a vector input since it is defined over vector values.
