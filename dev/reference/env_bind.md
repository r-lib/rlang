...
- ...:
  ...
  (`env_bind_active()`). Use
  [`zap()`](https://rlang.r-lib.org/dev/reference/zap.md) to remove
  bindings.
...
[`env()`](https://rlang.r-lib.org/dev/reference/env.md) documentation),
...
[`env_poke()`](https://rlang.r-lib.org/dev/reference/env_poke.md) for
