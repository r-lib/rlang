...
Using [`expr()`](https://rlang.r-lib.org/dev/reference/expr.md) we can
...
mask](https://rlang.r-lib.org/dev/reference/topic-data-mask.md). This
makes it possible for the expression to refer to columns of a data frame
as if they were regular objects.
...
with [`expr()`](https://rlang.r-lib.org/dev/reference/expr.md), and even
...
operator](https://rlang.r-lib.org/dev/reference/embrace-operator.md)
`{{`. It allows the data-masking function to defuse the correct
expression.
...
[`expr()`](https://rlang.r-lib.org/dev/reference/expr.md):
...
- You can defuse the expressions supplied by *the user* of your function
  ...
  [`enquos()`](https://rlang.r-lib.org/dev/reference/enquo.md). These
...
pattern](https://rlang.r-lib.org/dev/reference/topic-metaprogramming.md).
...
Using [`enquo()`](https://rlang.r-lib.org/dev/reference/enquo.md) and
`!!` separately is useful in more complex cases where you need access to
the defused expression instead of just passing it on.

## Defused arguments and quosures

If you inspect the return values of
[`expr()`](https://rlang.r-lib.org/dev/reference/expr.md) and
[`enquo()`](https://rlang.r-lib.org/dev/reference/enquo.md), you'll
notice that the latter doesn't return a raw expression like the former.
Instead it returns a
[quosure](https://rlang.r-lib.org/dev/reference/quosure-tools.md), a
wrapper containing an expression and an environment.
...
they needed?](https://rlang.r-lib.org/dev/reference/topic-quosure.md).
...
- The equivalent of
  [`expr()`](https://rlang.r-lib.org/dev/reference/expr.md) is
  [`base::bquote()`](https://rdrr.io/r/base/bquote.html).

- The equivalent of
  [`enquo()`](https://rlang.r-lib.org/dev/reference/enquo.md) is
