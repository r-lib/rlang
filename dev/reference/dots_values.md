...
not flatten spliced objects, instead they are attributed a `spliced`
class (see
[`splice()`](https://rlang.r-lib.org/dev/reference/splice.md)). You can
process spliced objects manually, perhaps with a custom predicate (see
[`flatten_if()`](https://rlang.r-lib.org/dev/reference/flatten.md)).
