...
- Supply another condition as `parent` to create a [chained
  condition](https://rlang.r-lib.org/dev/reference/topic-error-chaining.md).
...
messages](https://rlang.r-lib.org/dev/reference/topic-condition-customisation.md).
...
- message:
  ...
  cli](https://rlang.r-lib.org/dev/reference/topic-condition-formatting.md)
...
- call:
  ...
  call](https://rlang.r-lib.org/dev/reference/topic-defuse.md) to
...
- parent:
  ...
  chains](https://rlang.r-lib.org/dev/reference/topic-error-chaining.md).
...
and a full backtrace with `summary(last_error())`. Learn how to control
what is displayed when an error is thrown with
