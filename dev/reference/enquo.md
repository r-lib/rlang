...
`enquo()` and `enquos()`
[defuse](https://rlang.r-lib.org/dev/reference/topic-defuse.md) function
...
- Interfacing with another
  ...
  function using the
  [defuse-and-inject](https://rlang.r-lib.org/dev/reference/topic-metaprogramming.md)
  pattern.

These are advanced tools. Make sure to first learn about the embrace
operator
[`{{`](https://rlang.r-lib.org/dev/reference/embrace-operator.md) in
...
`enquo()` returns a
[quosure](https://rlang.r-lib.org/dev/reference/topic-quosure.md) and
...
- [`expr()`](https://rlang.r-lib.org/dev/reference/expr.md) to defuse
  your own local expressions.

- [Advanced defusal
  operators](https://rlang.r-lib.org/dev/reference/defusing-advanced.md).
