...
topic](https://rlang.r-lib.org/dev/reference/topic-metaprogramming.md).
...
- Data-masked expressions (tidy eval): E.g.
  ...
  as [`{{`](https://rlang.r-lib.org/dev/reference/embrace-operator.md)
  and
  [`!!`](https://rlang.r-lib.org/dev/reference/injection-operator.md)
  and the [`.data`](https://rlang.r-lib.org/dev/reference/dot-data.md)
  and [`.env`](https://rlang.r-lib.org/dev/reference/dot-data.md)
  pronouns.
...
- Data-masked symbols: Same as data-masked arguments but the supplied
  ...
  evaluation](https://rlang.r-lib.org/dev/reference/topic-double-evaluation.md).
...
- [Dynamic dots](https://rlang.r-lib.org/dev/reference/dyn-dots.md):
  These may be data-masked arguments, tidy selections, or just regular
  arguments. Dynamic dots support injection of multiple arguments with
  the [`!!!`](https://rlang.r-lib.org/dev/reference/splice-operator.md)
  operator as well as name injection with
  [glue](https://rlang.r-lib.org/dev/reference/glue-operators.md)
  operators.
...
[`{{`](https://rlang.r-lib.org/dev/reference/embrace-operator.md) is a
...
- In a script, you can loop over a character vector with `for` or
  ...
  [`.data`](https://rlang.r-lib.org/dev/reference/dot-data.md) pattern
  to connect a name to its data-variable. A vector can also be supplied
  all at once to the tidy select helper `all_of()`.
...
is a tidy eval feature that is enabled in all data-masked arguments,
just like
[`{{`](https://rlang.r-lib.org/dev/reference/embrace-operator.md). The
