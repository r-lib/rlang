...
- [Splicing](https://rlang.r-lib.org/dev/reference/splice-operator.md)
  lists of arguments in a function call.
...
- Pass arguments to NSE functions that
  [defuse](https://rlang.r-lib.org/dev/reference/topic-defuse.md) their
