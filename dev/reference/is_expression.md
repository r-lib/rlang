...
the set of objects that can be obtained from parsing R code. Under this
...
[`base_env()`](https://rlang.r-lib.org/dev/reference/search_envs.md) is
a literal(in this case an atomic vector).
...
[`is_call()`](https://rlang.r-lib.org/dev/reference/is_call.md) for a
call predicate.
