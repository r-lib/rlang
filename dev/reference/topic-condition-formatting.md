...
### Transitioning from [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) to `cli_abort()`

If you plan to mass-rename calls from
[`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) to
...
[`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) calls in
your namespace, call
[`local_use_cli()`](https://rlang.r-lib.org/dev/reference/local_use_cli.md)
in the `onLoad` hook of your package. Using
[`on_load()`](https://rlang.r-lib.org/dev/reference/on_load.md) (make
sure to call
[`run_on_load()`](https://rlang.r-lib.org/dev/reference/on_load.md) in
your hook):

    on_load(local_use_cli())

Enabling cli formatting in
[`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) is useful
for:
...
- Using [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) when
  you'd like to disable interpolation syntax.

- Creating error conditions with
  [`error_cnd()`](https://rlang.r-lib.org/dev/reference/cnd.md). These
