...
[`!!`](https://rlang.r-lib.org/dev/reference/injection-operator.md), and
[`!!!`](https://rlang.r-lib.org/dev/reference/splice-operator.md) are an
...
masking](https://rlang.r-lib.org/dev/reference/topic-data-mask.md). It
is likely that the function will be called with data-variables
references which R won't be able to resolve properly:
...
[`!!`](https://rlang.r-lib.org/dev/reference/injection-operator.md) and
[`!!!`](https://rlang.r-lib.org/dev/reference/splice-operator.md) are
implemented in
[data-masked](https://rlang.r-lib.org/dev/reference/topic-data-mask.md)
arguments, [dynamic
dots](https://rlang.r-lib.org/dev/reference/dyn-dots.md), and within
[`inject()`](https://rlang.r-lib.org/dev/reference/inject.md). When used
in other contexts, they are interpreted by R as double and triple
*negations*.
