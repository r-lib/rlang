...
[`error_cnd()`](https://rlang.r-lib.org/dev/reference/cnd.md) create
errors of class `"rlang_error"`. The differences with base errors are:
...
- **\[experimental\]** The `use_cli_format` condition field instructs
  ...
  [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) within
  your package.
