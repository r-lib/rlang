...
[`try_fetch()`](https://rlang.r-lib.org/dev/reference/try_fetch.md) can
only match the class of a condition, not the class of its parents. To
match a class across the ancestry of an error, you'll need a bit of
craftiness.
...
which is able to perform the roles of both
[`tryCatch()`](https://rdrr.io/r/base/conditions.html) and
[`withCallingHandlers()`](https://rdrr.io/r/base/conditions.html).
...
[`try_fetch()`](https://rlang.r-lib.org/dev/reference/try_fetch.md).
Like [`withCallingHandlers()`](https://rdrr.io/r/base/conditions.html),
it doesn't capture a matching error right away. Instead, it captures it
only if the handler doesn't return a
[`zap()`](https://rlang.r-lib.org/dev/reference/zap.md) value.
...
Note that
[`try_fetch()`](https://rlang.r-lib.org/dev/reference/try_fetch.md) uses
