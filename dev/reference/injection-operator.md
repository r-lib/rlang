...
The [injection](https://rlang.r-lib.org/dev/reference/topic-inject.md)
...
expressions](https://rlang.r-lib.org/dev/reference/topic-defuse.md) like
[symbolised](https://rlang.r-lib.org/dev/reference/sym.md) column names.
...
- Functions taking
  ...
  [`{{`](https://rlang.r-lib.org/dev/reference/embrace-operator.md) or
...
Note that the
[`.env`](https://rlang.r-lib.org/dev/reference/dot-data.md) pronoun is a
simpler way of solving the ambiguity. See [The data mask
ambiguity](https://rlang.r-lib.org/dev/reference/topic-data-mask-ambiguity.md)
for more about this.
...
expression](https://rlang.r-lib.org/dev/reference/topic-defuse.md). In
the following example we use the [symbolise-and-inject
pattern](https://rlang.r-lib.org/dev/reference/topic-metaprogramming.md)
to inject a column name inside a data-masked expression.
...
you can't inject
[quosures](https://rlang.r-lib.org/dev/reference/topic-quosure.md), only
...
[`.env`](https://rlang.r-lib.org/dev/reference/dot-data.md) pronoun
solves the ambiguity problem in a more intuitive way:

    cyl <- 100
    mtcars %>% dplyr::mutate(cyl = cyl * .env$cyl)

Second, the embrace operator
[`{{`](https://rlang.r-lib.org/dev/reference/embrace-operator.md) makes
the [defuse-and-inject
pattern](https://rlang.r-lib.org/dev/reference/topic-metaprogramming.md)
