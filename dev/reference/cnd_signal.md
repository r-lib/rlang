...
- cnd:
  ...
  [`cnd()`](https://rlang.r-lib.org/dev/reference/cnd.md)). If `NULL`,
...
- [`cnd_type()`](https://rlang.r-lib.org/dev/reference/cnd_type.md) to
...
- [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md),
  ...
  [`inform()`](https://rlang.r-lib.org/dev/reference/abort.md) for
  creating and signalling structured R conditions in one go.
