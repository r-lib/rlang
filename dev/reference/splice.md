...
[`dots_list()`](https://rlang.r-lib.org/dev/reference/list2.md), and in
...
[`inject()`](https://rlang.r-lib.org/dev/reference/inject.md). While the
end result looks the same, the implementation is different and much more
...
[`dots_list()`](https://rlang.r-lib.org/dev/reference/list2.md). It does
not work in any other tidyeval context than these list collectors.
