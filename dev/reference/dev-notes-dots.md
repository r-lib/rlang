...
[`dots_list()`](https://rlang.r-lib.org/dev/reference/list2.md) are a
little tricky because they may error out in different situations. Do we
want to forward the context, i.e. set the call flag to the calling
environment? Collectors throw errors in these cases:
