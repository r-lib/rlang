...
[`as_box()`](https://rlang.r-lib.org/dev/reference/as_box.md) ensures
that a value is wrapped in a box.
[`as_box_if()`](https://rlang.r-lib.org/dev/reference/as_box.md) does
the same but only if the value matches a predicate.
