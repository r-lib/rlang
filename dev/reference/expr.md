...
`expr()`
[defuses](https://rlang.r-lib.org/dev/reference/topic-defuse.md) an R
expression with
[injection](https://rlang.r-lib.org/dev/reference/injection-operator.md)
support.
...
- [`enquo()`](https://rlang.r-lib.org/dev/reference/enquo.md) to defuse
...
- [`sym()`](https://rlang.r-lib.org/dev/reference/sym.md) and
  [`call2()`](https://rlang.r-lib.org/dev/reference/call2.md) for
  building expressions (symbols and calls respectively)
  programmatically.
