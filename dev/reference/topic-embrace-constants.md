...
[defused](https://rlang.r-lib.org/dev/reference/topic-defuse.md) into
[quosures](https://rlang.r-lib.org/dev/reference/topic-quosure.md) that
keep track of the environment of the defused expression.
...
- Data-masking APIs should be able to interpret constants. These can
  ...
  with `!!`. There should be no difference between
