...
mask](https://rlang.r-lib.org/dev/reference/topic-data-mask.md) with
[`as_data_mask()`](https://rlang.r-lib.org/dev/reference/as_data_mask.md).
Evaluating in a data mask enables the following features:

- [Quosures](https://rlang.r-lib.org/dev/reference/topic-quosure.md).
...
- [Pronouns](https://rlang.r-lib.org/dev/reference/dot-data.md). If
  `data` is supplied, the `.env` and `.data` pronouns are installed in
  the data mask. `.env` is a reference to the calling environment and
  `.data` refers to the `data` argument. These pronouns are an escape
  hatch for the [data mask
...
- expr:
  ...
  An [expression](https://rlang.r-lib.org/dev/reference/topic-defuse.md)
  or [quosure](https://rlang.r-lib.org/dev/reference/topic-quosure.md)
  to evaluate.
...
support, it is recommended to use `eval_tidy()` because users may inject
quosures.
...
See also
[`eval_bare()`](https://rlang.r-lib.org/dev/reference/eval_bare.md) for
