...
- **rlang errors**, a set of tools to signal and display errors. This
  ...
  Use [`abort()`](https://rlang.r-lib.org/dev/reference/abort.md) to
  create errors with bullet lists, structured metadata, and error
  chaining support.
...
- Checking function arguments,
  e.g. [`arg_match()`](https://rlang.r-lib.org/dev/reference/arg_match.md),
...
- Checking dots,
  e.g. [`check_dots_used()`](https://rlang.r-lib.org/dev/reference/check_dots_used.md)
  and
...
- Collecting [dynamic
  ...
  e.g. [`list2()`](https://rlang.r-lib.org/dev/reference/list2.md).
...
- The R session,
  e.g. [`check_installed()`](https://rlang.r-lib.org/dev/reference/is_installed.md),
  [`on_load()`](https://rlang.r-lib.org/dev/reference/on_load.md), and
  [`on_package_load()`](https://rlang.r-lib.org/dev/reference/on_load.md).

- Environments,
  e.g. [`env()`](https://rlang.r-lib.org/dev/reference/env.md),
...
- Evaluation,
  e.g. [`inject()`](https://rlang.r-lib.org/dev/reference/inject.md) and
  [`eval_bare()`](https://rlang.r-lib.org/dev/reference/eval_bare.md).

- Calls and symbols,
  e.g. [`call2()`](https://rlang.r-lib.org/dev/reference/call2.md),
  [`is_call()`](https://rlang.r-lib.org/dev/reference/is_call.md),
  [`is_call_simple()`](https://rlang.r-lib.org/dev/reference/call_name.md),
  [`data_sym()`](https://rlang.r-lib.org/dev/reference/sym.md), and
  [`data_syms()`](https://rlang.r-lib.org/dev/reference/sym.md).

- Functions,
  e.g. [`new_function()`](https://rlang.r-lib.org/dev/reference/new_function.md)
  and
