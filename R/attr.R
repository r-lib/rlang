...
#' the names are missing or empty (`NA` or `""`). `is_dictionarish()`
...
#' @return `is_named()` and `is_dictionarish()` are scalar predicates
...
#' # is_dictionarish() returns TRUE for empty objects:
#' is_dictionarish(list())
#'
