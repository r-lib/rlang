...
[injection](https://rlang.r-lib.org/reference/topic-inject.md) in
particular:
...
2.  You can **inject** names with [glue
    syntax](https://rlang.r-lib.org/reference/glue-operators.md) on the
    left-hand side of `:=`.
...
[`list2()`](https://rlang.r-lib.org/reference/list2.md) instead of
[`list()`](https://rdrr.io/r/base/list.html). See also
[`dots_list()`](https://rlang.r-lib.org/reference/list2.md), which
