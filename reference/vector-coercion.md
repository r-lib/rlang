...
`as_character()` and
[`as_string()`](https://rlang.r-lib.org/reference/as_string.md) have an
optional `encoding` argument to specify the encoding. R uses this
...
Note that only
[`as_string()`](https://rlang.r-lib.org/reference/as_string.md) can
...
[`duplicate()`](https://rlang.r-lib.org/reference/duplicate.md)).
