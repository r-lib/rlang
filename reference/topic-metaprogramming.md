...
are sufficient for most purposes. Sometimes however, it is necessary to
decompose the forwarding action into its two constitutive steps,
[defusing](https://rlang.r-lib.org/reference/topic-defuse.md) and
[injecting](https://rlang.r-lib.org/reference/topic-inject.md).

`{{` is the combination of
[`enquo()`](https://rlang.r-lib.org/reference/enquo.md) and
[`!!`](https://rlang.r-lib.org/reference/injection-operator.md). These
functions are completely equivalent:
...
[defused
expressions](https://rlang.r-lib.org/reference/topic-defuse.md). Once
defused, you can inspect or modify the expressions before injecting them
...
[`enquos()`](https://rlang.r-lib.org/reference/enquo.md). Set `.named`
to `TRUE` to automatically call
[`as_label()`](https://rlang.r-lib.org/reference/as_label.md) on the
...
[defused expressions](https://rlang.r-lib.org/reference/topic-defuse.md)
that refer to the data-variables represented in the names vector. These
are then injected in the data mask context.

Symbolise a single string with
[`sym()`](https://rlang.r-lib.org/reference/sym.md) or
...
[`syms()`](https://rlang.r-lib.org/reference/sym.md) or
...
[`syms()`](https://rlang.r-lib.org/reference/sym.md) work in a wider
variety of cases (with base functions in particular) but we'll use
mostly use [`data_sym()`](https://rlang.r-lib.org/reference/sym.md) and
[`data_syms()`](https://rlang.r-lib.org/reference/sym.md) because they
are more robust (see [The data mask
...
operator [`!!!`](https://rlang.r-lib.org/reference/splice-operator.md),
which injects each element of the list as a separate argument. For
instance, to implement a `group_by()` variant that takes a character
...
[`enquos()`](https://rlang.r-lib.org/reference/enquo.md) and
[`!!!`](https://rlang.r-lib.org/reference/splice-operator.md). We'll
...
collisions](https://rlang.r-lib.org/reference/topic-data-mask-ambiguity.md).
...
[`inject()`](https://rlang.r-lib.org/reference/inject.md):
...
[`sym()`](https://rlang.r-lib.org/reference/sym.md) is a way of
sanitising inputs.
