...
[`abort()`](https://rlang.r-lib.org/reference/abort.md) includes the
...
[`abort()`](https://rlang.r-lib.org/reference/abort.md) is called
directly within the failing function. However, when the
[`abort()`](https://rlang.r-lib.org/reference/abort.md) call is exported
to another function (which we call an "error helper"), we need to be
explicit about which function
[`abort()`](https://rlang.r-lib.org/reference/abort.md) is throwing an
error for.
...
- Simple [`abort()`](https://rlang.r-lib.org/reference/abort.md)
...
To fix this, let [`abort()`](https://rlang.r-lib.org/reference/abort.md)
know about the function that it is throwing the error for by passing the
...
### Input checkers and [`caller_arg()`](https://rlang.r-lib.org/reference/caller_arg.md)

The [`caller_arg()`](https://rlang.r-lib.org/reference/caller_arg.md)
...
[`rlang::as_label()`](https://rlang.r-lib.org/reference/as_label.md)
