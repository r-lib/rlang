...
[`{{`](https://rlang.r-lib.org/reference/embrace-operator.md) should be
used exclusively with function arguments:
...
[`enquo()`](https://rlang.r-lib.org/reference/enquo.md) (on which `{{`
is based).
...
environment?](https://rlang.r-lib.org/reference/topic-embrace-constants.md)
for more about this.
