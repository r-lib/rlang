...
[`inform()`](https://rlang.r-lib.org/reference/abort.md) and are given
the class `"rlib_message_name_repair"`. These messages can be muffled
with [`base::suppressMessages()`](https://rdrr.io/r/base/message.html).
