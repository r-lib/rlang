...
dots](https://rlang.r-lib.org/reference/dyn-dots.md) injects a list of
arguments into a function call. It belongs to the family of
[injection](https://rlang.r-lib.org/reference/topic-inject.md) operators
and provides the same functionality as
...
- Functions taking [dynamic
  dots](https://rlang.r-lib.org/reference/dyn-dots.md) like
...
function we used
[`inject()`](https://rlang.r-lib.org/reference/inject.md) to explicitly
enable `!!!`. However, many functions implement [dynamic
dots](https://rlang.r-lib.org/reference/list2.md) with `!!!` implicitly
...
expressions](https://rlang.r-lib.org/reference/topic-defuse.md) into
[data-masked](https://rlang.r-lib.org/reference/topic-data-mask.md)
...
pattern](https://rlang.r-lib.org/reference/topic-data-mask-programming.md)
...
Take this [dynamic dots](https://rlang.r-lib.org/reference/dyn-dots.md)
function:
...
[`list2()`](https://rlang.r-lib.org/reference/list2.md) is a dots
collector that special-cases `!!!` arguments. On the other hand,
[`inject()`](https://rlang.r-lib.org/reference/inject.md) operates on
the language and creates a function call containing as many arguments as
there are elements in the spliced list. If you supply a list of size
1e6, [`inject()`](https://rlang.r-lib.org/reference/inject.md) is
...
same as in [`inject()`](https://rlang.r-lib.org/reference/inject.md).
...
- [`exec()`](https://rlang.r-lib.org/reference/exec.md)
