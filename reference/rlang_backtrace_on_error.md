...
[`last_error()`](https://rlang.r-lib.org/reference/last_error.md). You
can also control the default display of the backtrace by setting the
...
[`abort()`](https://rlang.r-lib.org/reference/abort.md). If you promote
base errors to rlang errors with
...
- It saves the base error as an rlang object so you can call
  [`last_error()`](https://rlang.r-lib.org/reference/last_error.md) to
  print the backtrace or inspect its data.
...
- Expected errors are controlled by the global option
  ...
  You can also use
  [`last_error()`](https://rlang.r-lib.org/reference/last_error.md) to
  display the trace like you would in your session, but it currently
