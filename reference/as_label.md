...
See also [`as_name()`](https://rlang.r-lib.org/reference/as_name.md) for
transforming symbols back to a string. Unlike `as_label()`,
[`as_name()`](https://rlang.r-lib.org/reference/as_name.md) is a well
defined operation that guarantees the roundtrip symbol -\> string -\>
symbol.
...
- Quosures are
  [squashed](https://rlang.r-lib.org/reference/quo_squash.md) before
  being labelled.

- Symbols are transformed to string with
  [`as_string()`](https://rlang.r-lib.org/reference/as_string.md).
