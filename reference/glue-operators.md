...
[Dynamic dots](https://rlang.r-lib.org/reference/dyn-dots.md) (and
[data-masked](https://rlang.r-lib.org/reference/topic-data-mask.md) dots
which are dynamic by default) have built-in support for names
...
[`{{`](https://rlang.r-lib.org/reference/embrace-operator.md) inserts
the expression supplied as argument in the string. This gives an
...
See also [`englue()`](https://rlang.r-lib.org/reference/englue.md) to
string-embrace outside of dynamic dots.
...
Technically, `"{{"`
[defuses](https://rlang.r-lib.org/reference/topic-defuse.md) a function
argument, calls
...
[`{{`](https://rlang.r-lib.org/reference/embrace-operator.md) available
in [data-masked](https://rlang.r-lib.org/reference/topic-data-mask.md)
arguments.
...
objects?](https://rlang.r-lib.org/reference/topic-embrace-non-args.md)
...
This is where [`englue()`](https://rlang.r-lib.org/reference/englue.md)
becomes useful. We can pull out the default name creation in another
user-facing argument like this:
