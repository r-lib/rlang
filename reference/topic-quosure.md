...
dplyr (using the
[define-a-constant](https://rlang.r-lib.org/reference/topic-double-evaluation.md)
...
[`enquo()`](https://rlang.r-lib.org/reference/enquo.md) or
[`enquos()`](https://rlang.r-lib.org/reference/enquo.md) (even though
you generally don't need to know or care that these functions return
quosures). In this section, we explore when quosures are necessary in
...
[`enquo()`](https://rlang.r-lib.org/reference/enquo.md) or
[`enquos()`](https://rlang.r-lib.org/reference/enquo.md) (or with
[`{{`](https://rlang.r-lib.org/reference/embrace-operator.md) which
calls [`enquo()`](https://rlang.r-lib.org/reference/enquo.md)
implicitly):
...
Using [`quo()`](https://rlang.r-lib.org/reference/defusing-advanced.md)
instead of [`expr()`](https://rlang.r-lib.org/reference/expr.md) would
have worked too but it is superfluous because
[`dplyr::summarise()`](https://dplyr.tidyverse.org/reference/summarise.html),
which uses [`enquos()`](https://rlang.r-lib.org/reference/enquo.md), is
already in charge of wrapping your expression within a quosure scoped in
your environment.

The same applies if you evaluate manually. By default,
[`eval()`](https://rdrr.io/r/base/eval.html) and
[`eval_tidy()`](https://rlang.r-lib.org/reference/eval_tidy.md) capture
your environment:
...
columns without
...](https://rlang.r-lib.org/reference/topic-multiple-columns.md).
...
- It is *callable*. Evaluation produces a result.
  ...
  [`eval_tidy()`](https://rlang.r-lib.org/reference/eval_tidy.md). We
  would like to fix this limitation in the future.

- It is *hygienic*. It evaluates in the tracked environment.

- It is *maskable*. If evaluated in a data mask (currently only masks
  created with
  [`eval_tidy()`](https://rlang.r-lib.org/reference/eval_tidy.md) or
...
- [`enquo()`](https://rlang.r-lib.org/reference/enquo.md) and
  [`enquos()`](https://rlang.r-lib.org/reference/enquo.md) to defuse
  function arguments as quosures. This is the main way quosures are
  created.

- [`quo()`](https://rlang.r-lib.org/reference/defusing-advanced.md)
  which is like [`expr()`](https://rlang.r-lib.org/reference/expr.md)
  but wraps in a quosure. Usually it is not needed to wrap local
...
- [`new_quosure()`](https://rlang.r-lib.org/reference/new_quosure.md)
  and [`as_quosure()`](https://rlang.r-lib.org/reference/new_quosure.md)
