...
[symbolic](https://rlang.r-lib.org/reference/is_expression.md) objects
in R. They represent the action of calling a function, possibly with
arguments. There are two ways of creating a quoted call:

- By [quoting](https://rlang.r-lib.org/reference/topic-defuse.md) it.
  Quoting prevents functions from being called. Instead, you get the
...
- The function to call can be a string or a
  ...
  symbol, another call (e.g. a `$` or `[[` call), or a function to
  inline. [`base::call()`](https://rdrr.io/r/base/call.html) only
  supports strings and you need to use
...
- `call2()` has [dynamic
  dots](https://rlang.r-lib.org/reference/list2.md) support. You can
...
environment](https://rlang.r-lib.org/reference/empty_env.md).
