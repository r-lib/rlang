...
They rely on
[`eval_bare()`](https://rlang.r-lib.org/reference/eval_bare.md) which
features a lighter evaluation mechanism than base R
...
- env:
  ...
  a [`get_env()`](https://rlang.r-lib.org/reference/get_env.md) method.
