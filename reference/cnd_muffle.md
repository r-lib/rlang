...
Unlike [`exiting()`](https://rlang.r-lib.org/reference/with_handlers.md)
handlers,
[`calling()`](https://rlang.r-lib.org/reference/with_handlers.md)
...
- Bare conditions signalled with
  [`signal()`](https://rlang.r-lib.org/reference/abort.md) or
...
- Conditions captured with
  ...
  or [`catch_cnd()`](https://rlang.r-lib.org/reference/catch_cnd.md) are
  no longer mufflable. Muffling restarts *must* be called from a
  [calling](https://rlang.r-lib.org/reference/with_handlers.md) handler.
