...
[`as_label()`](https://rlang.r-lib.org/reference/as_label.md) or
[`as_name()`](https://rlang.r-lib.org/reference/as_name.md) instead of
`quo_name()`. See life cycle section below.

These functions take an arbitrary R object, typically an
[expression](https://rlang.r-lib.org/reference/is_expression.md), and
...
[`as_string()`](https://rlang.r-lib.org/reference/as_string.md) instead
of `quo_name()`. Unlike deparsing, the transformation between symbols
...
- [`as_label()`](https://rlang.r-lib.org/reference/as_label.md) and
  [`as_name()`](https://rlang.r-lib.org/reference/as_name.md) should be
  used instead of `quo_name()`.
  ...
  [`as_name()`](https://rlang.r-lib.org/reference/as_name.md) only works
  with (possibly quosured) symbols, but is a well defined and
...
[`expr_label()`](https://rlang.r-lib.org/reference/expr_label.md),
[`f_label()`](https://rlang.r-lib.org/reference/f_text.md)
