...
sentinel](https://rlang.r-lib.org/reference/zap.md) if the binding did
not exist yet.
...
[`env_bind()`](https://rlang.r-lib.org/reference/env_bind.md) for
binding multiple elements.
[`env_cache()`](https://rlang.r-lib.org/reference/env_cache.md) for a
variant of `env_poke()` designed to cache values.
