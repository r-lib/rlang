...
- The `name` attribute of `env` if it exists. This is how the [package
  environments](https://rlang.r-lib.org/reference/search_envs.md) and
  the [imports
  environments](https://rlang.r-lib.org/reference/ns_env.md) store their
  names. The name of package environments is typically "package:pkg".
