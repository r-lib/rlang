...
- The [dynamic dots](https://rlang.r-lib.org/reference/dyn-dots.md)
  operators,
  [`!!!`](https://rlang.r-lib.org/reference/splice-operator.md) and
  [`"{"`](https://rlang.r-lib.org/reference/glue-operators.md).

- The [metaprogramming
  operators](https://rlang.r-lib.org/reference/topic-metaprogramming.md)
  [`!!`](https://rlang.r-lib.org/reference/injection-operator.md),
  [`{{`](https://rlang.r-lib.org/reference/embrace-operator.md), and
  [`"{{"`](https://rlang.r-lib.org/reference/glue-operators.md).
  Splicing with
  [`!!!`](https://rlang.r-lib.org/reference/splice-operator.md) can also
  be done in metaprogramming context.

## Dots injection

Unlike regular `...`, [dynamic
dots](https://rlang.r-lib.org/reference/dyn-dots.md) are programmable
with injection operators.
...
[`{{`](https://rlang.r-lib.org/reference/embrace-operator.md) is made
specially for function arguments. It
[defuses](https://rlang.r-lib.org/reference/topic-defuse.md) the
...
mask](https://rlang.r-lib.org/reference/topic-data-mask.md).
...
Unlike [`!!!`](https://rlang.r-lib.org/reference/splice-operator.md)
...
instance, the [`.data`](https://rlang.r-lib.org/reference/dot-data.md)
and [`.env`](https://rlang.r-lib.org/reference/dot-data.md) pronouns
...
The splice operator
[`!!!`](https://rlang.r-lib.org/reference/splice-operator.md) of dynamic
dots can also be used in metaprogramming context (inside
[data-masked](https://rlang.r-lib.org/reference/topic-data-mask.md)
arguments and inside
[`inject()`](https://rlang.r-lib.org/reference/inject.md)). For
instance, we could reimplement the `rbind2()` function presented above
using [`inject()`](https://rlang.r-lib.org/reference/inject.md) instead
of [`do.call()`](https://rdrr.io/r/base/do.call.html):
...
[`list2()`](https://rlang.r-lib.org/reference/list2.md) so that the
callers of `rbind2()` may use `!!!`. And we use
[`inject()`](https://rlang.r-lib.org/reference/inject.md) so that
...
[`expr()`](https://rlang.r-lib.org/reference/expr.md) is similar to a
quasiquotation operator and `!!` is the unquote operator. These terms
