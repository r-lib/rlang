...
behaviours](https://rlang.r-lib.org/reference/topic-data-mask-programming.md)
...
[defuse](https://rlang.r-lib.org/reference/topic-defuse.md) the
...
alias to
[`quos()`](https://rlang.r-lib.org/reference/defusing-advanced.md)) is
provided so that users can defuse their arguments externally.
