...
[quosures](https://rlang.r-lib.org/reference/topic-quosure.md), a type
of [defused
...
- ns:
  ...
  [`is_call()`](https://rlang.r-lib.org/reference/is_call.md) returns
  `FALSE`. If any other string,
  [`is_call()`](https://rlang.r-lib.org/reference/is_call.md) checks
...
[`quos()`](https://rlang.r-lib.org/reference/defusing-advanced.md), they
are returned as an empty quosure. These quosures contain the [missing
argument](https://rlang.r-lib.org/reference/missing_arg.md) and
typically have the [empty
environment](https://rlang.r-lib.org/reference/empty_env.md) as
enclosure.
...
- [`quo()`](https://rlang.r-lib.org/reference/defusing-advanced.md) for
  creating quosures by [argument
  defusal](https://rlang.r-lib.org/reference/topic-defuse.md).
...
- [What are quosures and when are they
  needed?](https://rlang.r-lib.org/reference/topic-quosure.md) for an
  overview.
