...
* The quosure print method has been improved. Quosures are displayed
  as a flat expression along with the environment.

  Note that this method is not invoked when printing raw
