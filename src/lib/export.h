...
static inline void r_register_c_callable(const char* pkg, const char* ptr_name, r_fn_ptr_t fn) {
...
static inline r_fn_ptr_t r_peek_c_callable(const char* pkg, const char* callable) {
