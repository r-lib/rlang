...
static const R_CallMethodDef r_callables[] = {
    ...
    {"ffi_env_dot_delayed_env", (DL_FUNC) &ffi_env_dot_delayed_env, 2},
    {"ffi_env_dot_delayed_expr", (DL_FUNC) &ffi_env_dot_delayed_expr, 2},
    {"ffi_env_dot_forced_expr", (DL_FUNC) &ffi_env_dot_forced_expr, 2},
    {"ffi_env_dot_type", (DL_FUNC) &ffi_env_dot_type, 2},
    {"ffi_env_dot_get", (DL_FUNC) &ffi_env_dot_get, 2},
    {"ffi_env_dots_exist", (DL_FUNC) &ffi_env_dots_exist, 1},
    {"ffi_env_dots_length", (DL_FUNC) &ffi_env_dots_length, 1},
    {"ffi_env_dots_names", (DL_FUNC) &ffi_env_dots_names, 1},
    ...
    {"ffi_env_binding_delayed_env", (DL_FUNC) &ffi_env_binding_delayed_env, 2},
    {"ffi_env_binding_delayed_expr",
     (DL_FUNC) &ffi_env_binding_delayed_expr,
     2},
    {"ffi_env_binding_forced_expr", (DL_FUNC) &ffi_env_binding_forced_expr, 2},
    {"ffi_env_binding_type", (DL_FUNC) &ffi_env_binding_type, 2},
    ...
    {"ffi_standalone_check_number_1.0.7",
     (DL_FUNC) &ffi_standalone_check_number,
     7},
