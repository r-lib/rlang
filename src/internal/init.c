...
static const R_CallMethodDef r_callables[] = {
  ...
  {"ffi_arr_info",                     (DL_FUNC) &ffi_arr_info, 1},
  {"ffi_arr_pop_back",                 (DL_FUNC) &ffi_arr_pop_back, 1},
  {"ffi_arr_push_back",                (DL_FUNC) &ffi_arr_push_back, 2},
  {"ffi_arr_push_back_bool",           (DL_FUNC) &ffi_arr_push_back_bool, 2},
  {"ffi_arr_resize",                   (DL_FUNC) &ffi_arr_resize, 2},
  {"ffi_arr_unwrap",                   (DL_FUNC) &ffi_arr_unwrap, 1},
  ...
  {"ffi_env_get",                      (DL_FUNC) &ffi_env_get, 4},
  {"ffi_env_get_list",                 (DL_FUNC) &ffi_env_get_list, 4},
  ...
  {"ffi_is_character",                 (DL_FUNC) &ffi_is_character, 2},
