...
r_obj* (*r_sym_as_character)(r_obj* x) = NULL;
r_obj* (*r_sym_as_string)(r_obj* x) = NULL;

void r_init_library_sym() {
  r_sym_as_character = (r_obj* (*)(r_obj*)) r_peek_c_callable("rlang", "rlang_sym_as_character");
  r_sym_as_string = (r_obj* (*)(r_obj*)) r_peek_c_callable("rlang", "rlang_sym_as_string");
}
