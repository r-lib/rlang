...
static inline void* r_vec_begin0(enum r_type type, r_obj* x) {
  switch (type) {
  case R_TYPE_logical:
...
static inline const void* r_vec_cbegin0(enum r_type type, r_obj* x) {
  switch (type) {
  case R_TYPE_logical:
...
static inline int r_vec_elt_sizeof0(enum r_type type) {
  switch (type) {
  case R_TYPE_logical:
    return sizeof(int);
  case R_TYPE_integer:
...
static inline r_obj* r_alloc_vector(enum r_type type, r_ssize n) {
...
static inline r_obj* r_vec_n(enum r_type type, void* v_src, r_ssize n) {
  switch (type) {
  case R_TYPE_logical:
  case R_TYPE_integer:
  case R_TYPE_double:
